...
/* Created on:     3/9/2017 12:02:56 AM                         */
/*==============================================================*/
...
drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_A
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_A
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_A
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_AUD
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_C
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_C
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_C
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION
/
...
drop trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION_AU
/
...
drop trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION_RE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_G
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_G
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_G
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_GROUP
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_N
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_N
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_N
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_NUCLEOTIDE_SEQUENCE
/
...
drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_R
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_R
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_R
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_REJECTION_REASON_ST
/
...
drop trigger GENOMIC_REF_DATA.TIB_ALLELE_REJECTION_STG
/
...
drop trigger GENOMIC_REF_DATA.TIB_ALLELE_RELATIONSHIP
/
...
drop trigger GENOMIC_REF_DATA.TIB_ALLELE_RELATIONSHIP_STG
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_S
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_S
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_S
/

drop trigger GENOMIC_REF_DATA.TIB_ALLELE_STG
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_BEHAVIOR
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_BEHAVIOR
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_BEHAVIOR
/

drop trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_EXPANSION_
/
...
drop trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_GROUP
/
...
drop trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_GRP_VER_EX
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_CURATOR_
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_CURATOR_
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_CURATOR_
/

drop trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA
/
...
drop trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA_NOTIFICATION
/
...
drop trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA_RELEASE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_EXPR_CHA
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_EXPR_CHA
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_EXPR_CHA
/

drop trigger GENOMIC_REF_DATA.TIB_EXPR_CHAR_SET
/
...
drop trigger GENOMIC_REF_DATA.TIB_EXPR_CHAR_SET_VER_MEMBER
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENE_LOC
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENE_LOC
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENE_LOC
/

drop trigger GENOMIC_REF_DATA.TIB_GENE_LOCUS
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOME_D
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOME_D
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOME_D
/

drop trigger GENOMIC_REF_DATA.TIB_GENOME_DATABASE_VERSION
/
...
drop trigger GENOMIC_REF_DATA.TIB_GENOME_DATABASE_VERSION_ST
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOMIC_
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOMIC_
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOMIC_
/

drop trigger GENOMIC_REF_DATA.TIB_GENOMIC_REF_DATA_CONFIGURA
/
...
drop trigger GENOMIC_REF_DATA.TIB_GENOMIC_REF_OBJ_LEGACY_XRE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOTYPE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOTYPE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOTYPE
/

drop trigger GENOMIC_REF_DATA.TIB_GENOTYPE
/
...
drop trigger GENOMIC_REF_DATA.TIB_GENOTYPE_LIST
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GROUP_MI
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GROUP_MI
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GROUP_MI
/

drop trigger GENOMIC_REF_DATA.TIB_GROUP_MISMATCH
/
...
drop trigger GENOMIC_REF_DATA.TIB_GROUP_MISMATCH_MEMBER
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_HAPLOTYP
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_HAPLOTYP
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_HAPLOTYP
/

drop trigger GENOMIC_REF_DATA.TIB_HAPLOTYPE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_NOMENCLA
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_NOMENCLA
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_NOMENCLA
/

drop trigger GENOMIC_REF_DATA.TIB_NOMENCLATURE_MISMATCH
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_NOM_FILE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_NOM_FILE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_NOM_FILE
/

drop trigger GENOMIC_REF_DATA.TIB_NOM_FILE_GROUP_MEMBER_STG
/
...
drop trigger GENOMIC_REF_DATA.TIB_NOM_FILE_GROUP_STG
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
/

drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_CITATION
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_CITATION_
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_FEATURE
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_FEATURE_S
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_GROUP
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_GROUP_STG
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SOURCE_XR
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SRC_MATER
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SRC_XREF_
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBL_ALL
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBL_ALL
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBL_ALL
/

drop trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GROUP_VER_MBR_
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GROUP_VER_MEMB
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GRP_VER_MBR_AU
/
...
drop trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_SRC_MATERIAL_S
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_SEARCH_D
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_SEARCH_D
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_SEARCH_D
/

drop trigger GENOMIC_REF_DATA.TIB_SEARCH_DETERMINANT
/
...
drop trigger GENOMIC_REF_DATA.TIB_SEARCH_DETERMINANT_RLTSHP
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_SEROLOGY
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_SEROLOGY
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_SEROLOGY
/

drop trigger GENOMIC_REF_DATA.TIB_SEROLOGY
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_TEST_RES
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_TEST_RES
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_TEST_RES
/

drop trigger GENOMIC_REF_DATA.TIB_TEST_RESULT_ALLELE_GROUP
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_USERS
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_USERS
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_USERS
/

drop trigger GENOMIC_REF_DATA.TIB_USERS
/

drop trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_XX_ALLEL
/

drop trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_XX_ALLEL
/

drop trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_XX_ALLEL
/

drop trigger GENOMIC_REF_DATA.TIB_XX_ALLELE_GROUP
/

drop index GENOMIC_REF_DATA.IDX_ALLELE_02
/

drop index GENOMIC_REF_DATA.IDX_ALLELE_01
/
...
drop index GENOMIC_REF_DATA.IDX_ALLELE_STG_01
/
...
Begin
Execute Immediate ('drop table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION cascade constraints');
Exception when others then
If sqlcode = -942 then
     Null;
   Else
...
Begin
Execute Immediate ('drop table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER cascade constraints');
Exception when others then
If sqlcode = -942 then
     Null;
   Else
...
/* Index: IDX_ALLELE_01                                         */
/*==============================================================*/
create index GENOMIC_REF_DATA.IDX_ALLELE_01 on GENOMIC_REF_DATA.ALLELE (
   ACCESSION_NUM ASC
)
tablespace GENOMIC_REF_DATA_IDX
/

/*==============================================================*/
/* Index: IDX_ALLELE_02                                         */
/*==============================================================*/
create index GENOMIC_REF_DATA.IDX_ALLELE_02 on GENOMIC_REF_DATA.ALLELE (
   LONG_FORMAT_NME ASC
)
tablespace GENOMIC_REF_DATA_IDX
/
...
(
   ...
   ALLELE_GROUP_SUFFIX_TXT VARCHAR2(200),
   CREATE_TS            TIMESTAMP(6)         not null,
   CREATE_BY_ID         VARCHAR2(50)         not null,
   UPDATE_TS            TIMESTAMP(6)         not null,
   UPDATE_BY_ID         VARCHAR2(50)         not null,
...
(
   ...
   MANUAL_REVIEW_STAT_CDE VARCHAR2(10),
...
/*==============================================================*/
/* Index: IDX_ALLELE_STG_01                                     */
/*==============================================================*/
create index GENOMIC_REF_DATA.IDX_ALLELE_STG_01 on GENOMIC_REF_DATA.ALLELE_STG (
   ACCESSION_NUM ASC
)
tablespace GENOMIC_REF_DATA_IDX
/
...
comment on column GENOMIC_REF_DATA.GROUP_MISMATCH.ALLELE_GROUP_SUFFIX_CDE is
'A valid value to represent a specific kind of published allele group type.  Preliminary values are P = Protein Groups, G = Genomic Groups.  The ''P'' groups are for HLA Alleles that encode for identical protien in the peptide-binding-domains, and the ''G'' groups are for HLA alleles that share identical nucleotide sequences for the exons encoding the peptide-bidning-domains.'
/
...
(
   MANUAL_REVIEW_STAT_CDE VARCHAR2(10)         not null,
   MANUAL_REVIEW_STAT_NME VARCHAR2(50)         not null,
   MANUAL_REVIEW_STAT_TXT VARCHAR2(100),
   CREATE_TS            TIMESTAMP(6)         not null,
   CREATE_BY_ID         VARCHAR2(50)         not null,
   UPDATE_TS            TIMESTAMP(6)         not null,
   UPDATE_BY_ID         VARCHAR2(50)         not null,
...
comment on column GENOMIC_REF_DATA.NOM_FILE_GROUP_STG.ALLELE_GROUP_SUFFIX_CDE is
'A valid value to represent a specific kind of published allele group type.  Preliminary values are P = Protein Groups, G = Genomic Groups.  The ''P'' groups are for HLA Alleles that encode for identical protien in the peptide-binding-domains, and the ''G'' groups are for HLA alleles that share identical nucleotide sequences for the exons encoding the peptide-bidning-domains.'
/
...
/*==============================================================*/
/* Table: XX_ALLELE_GROUP_VERSION                               */
/*==============================================================*/
create table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION 
(
   XX_ALLELE_GROUP_VERSION_IID NUMBER(9)            not null,
   XX_ALLELE_GROUP_IID  NUMBER(9)            not null,
   GENOME_DATABASE_VER_IID NUMBER(9)            not null,
   GENOMIC_REF_OBJECT_STATUS_CDE VARCHAR2(10)         not null,
   CREATE_TS            TIMESTAMP(6)         not null,
   ...
   UPDATE_TS            TIMESTAMP(6)         not null,
   UPDATE_BY_ID         VARCHAR2(50)         not null,
   constraint PK_XX_ALLELE_GROUP_VERSION primary key (XX_ALLELE_GROUP_VERSION_IID)
         using index tablespace GENOMIC_REF_DATA_IDX,
   constraint AK_XX_ALLELE_GROUP_VERSION unique (XX_ALLELE_GROUP_IID, GENOME_DATABASE_VER_IID)
         using index tablespace GENOMIC_REF_DATA_IDX
)
tablespace GENOMIC_REF_DATA
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.XX_ALLELE_GROUP_IID is
'A system generated identifier (surrogate key) that uniquely represents an XX Group within the Enterprise. '
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.GENOME_DATABASE_VER_IID is
'A system generated identifier (surrogate key) that uniquely represents a genome database version within the Enterprise.  '
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.GENOMIC_REF_OBJECT_STATUS_CDE is
'A valid value to represent a specific status for an Allele, Allele Code Designation or XX Allele Group.  Values are Valid = Valid, Depr = Deprecated, and Invalid = Invalid.  Note - until an allele goes through the validation process it resides in staging structures; if determined to be NOT Valid, the record is removed and NEVER operationalized.  '
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.CREATE_TS is
'The record created timestamp in the database'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.CREATE_BY_ID is
'The user id / unique id of the person / program created the record'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.UPDATE_TS is
'The record updated timestamp in the database'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION.UPDATE_BY_ID is
'The user id / unique id of the person / program updated the record. '
/

/*==============================================================*/
/* Table: XX_ALLELE_GROUP_VER_MEMBER                            */
/*==============================================================*/
create table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER 
(
   XX_ALLELE_GROUP_VERSION_IID NUMBER(9),
   ALLELE_IID           NUMBER(9),
   CREATE_TS            TIMESTAMP(6)         not null,
   CREATE_BY_ID         VARCHAR2(50)         not null,
   UPDATE_TS            TIMESTAMP(6)         not null,
...
comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER.ALLELE_IID is
'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  '
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER.CREATE_TS is
'The record created timestamp in the database'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER.CREATE_BY_ID is
'The user id / unique id of the person / program created the record'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER.UPDATE_TS is
'The record updated timestamp in the database'
/

comment on column GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER.UPDATE_BY_ID is
'The user id / unique id of the person / program updated the record. '
/
...
alter table GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION
   add constraint FK_ALLELE_CODE_DESIGNATION_02 foreign key (ALLELE_CODE_DESGNTN_STATUS_CDE)
      references GENOMIC_REF_DATA.GENOMIC_REF_OBJECT_STATUS (GENOMIC_REF_OBJECT_STATUS_CDE)
/
...
alter table GENOMIC_REF_DATA.ALLELE_COMMON_WELL_DOC_STG
   add constraint ALLELE_COMMON_WELL_DOC_STG_01 foreign key (COMMON_WELL_DOC_STATUS_CDE)
      references GENOMIC_REF_DATA.COMMON_WELL_DOCUMENTED_STATUS (COMMON_WELL_DOC_STATUS_CDE)
/
...
alter table GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_STG
   add constraint FK_ALLELE_RELATIONSHIP_STG_03 foreign key (ALLELE_RELATIONSHIP_TYPE_CDE)
      references GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_TYPE (ALLELE_RELATIONSHIP_TYPE_CDE)
/
...
alter table GENOMIC_REF_DATA.ALLELE_STG
   add constraint FK_ALLELE_STG_09 foreign key (MANUAL_REVIEW_STAT_CDE)
...
alter table GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN
   add constraint FK_BEHVR_GRP_VER_EXPAN_01 foreign key (BEHAVIOR_ALLELE_GROUP_IID)
...
alter table GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN
   add constraint FK_BEHVR_GRP_VER_EXPAN_03 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION (GENOME_DATABASE_VER_IID)
/
...
alter table GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER
   add constraint FK_EXPR_CHAR_SET_VER_MBR_02 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION (GENOME_DATABASE_VER_IID)
/

alter table GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER
   add constraint FK_EXPR_CHAR_SET_VER_MBR_03 foreign key (ALLELE_IID)
      references GENOMIC_REF_DATA.ALLELE (ALLELE_IID)
/
...
alter table GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG
   add constraint FK_GENOME_DATABASE_VER_STG_01 foreign key (GENE_FAMILY_CDE)
      references GENOMIC_REF_DATA.GENE_FAMILY (GENE_FAMILY_CDE)
/
...
alter table GENOMIC_REF_DATA.GROUP_MISMATCH
   add constraint FK_GROUP_MISMATCH_05 foreign key (ALLELE_GROUP_SUFFIX_CDE)
      references GENOMIC_REF_DATA.ALLELE_GROUP_SUFFIX (ALLELE_GROUP_SUFFIX_CDE)
/
...
alter table GENOMIC_REF_DATA.NOM_FILE_GROUP_STG
   add constraint FK_NOM_FILE_GROUP_STG_01 foreign key (ALLELE_GROUP_SUFFIX_CDE)
      references GENOMIC_REF_DATA.ALLELE_GROUP_SUFFIX (ALLELE_GROUP_SUFFIX_CDE)
/
...
alter table GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG
   add constraint FK_PUBL_ALLELE_GROUP_STG_01 foreign key (GENE_LOCUS_IID)
      references GENOMIC_REF_DATA.GENE_LOCUS (GENE_LOCUS_IID)
/
...
alter table GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_STG
   add constraint FK_PUBL_ALLELE_GRP_VER_STG_03 foreign key (PUBL_ALLELE_GROUP_STATUS_CDE)
      references GENOMIC_REF_DATA.GENOMIC_REF_OBJECT_STATUS (GENOMIC_REF_OBJECT_STATUS_CDE)
/
...
alter table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION
   add constraint FK_XX_ALLELE_GROUP_VERSION_01 foreign key (XX_ALLELE_GROUP_IID)
      references GENOMIC_REF_DATA.XX_ALLELE_GROUP (XX_ALLELE_GROUP_IID)
/

alter table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION
   add constraint FK_XX_ALLELE_GROUP_VERSION_02 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION (GENOME_DATABASE_VER_IID)
/

alter table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION
   add constraint FK_XX_ALLELE_GROUP_VERSION_03 foreign key (GENOMIC_REF_OBJECT_STATUS_CDE)
      references GENOMIC_REF_DATA.GENOMIC_REF_OBJECT_STATUS (GENOMIC_REF_OBJECT_STATUS_CDE)
/

alter table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER
   add constraint XX_ALLELE_GROUP_VER_MEMBER_01 foreign key (XX_ALLELE_GROUP_VERSION_IID)
      references GENOMIC_REF_DATA.XX_ALLELE_GROUP_VERSION (XX_ALLELE_GROUP_VERSION_IID)
/

alter table GENOMIC_REF_DATA.XX_ALLELE_GROUP_VER_MEMBER
   add constraint XX_ALLELE_GROUP_VER_MEMBER_02 foreign key (ALLELE_IID)
      references GENOMIC_REF_DATA.ALLELE (ALLELE_IID)
/


create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE
for delete on GENOMIC_REF_DATA.ALLELE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE
for insert on GENOMIC_REF_DATA.ALLELE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE
for update on GENOMIC_REF_DATA.ALLELE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE before insert
on GENOMIC_REF_DATA.ALLELE for each row
declare
...
begin
    --  Column "ALLELE_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP
    select GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP.NEXTVAL INTO :new.ALLELE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_A
for delete on GENOMIC_REF_DATA.ALLELE_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_A
for insert on GENOMIC_REF_DATA.ALLELE_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_A
for update on GENOMIC_REF_DATA.ALLELE_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_AUD before insert
on GENOMIC_REF_DATA.ALLELE_AUD for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_AUD_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_AUD
    select GENOMIC_REF_DATA.SEQ_ALLELE_AUD.NEXTVAL INTO :new.ALLELE_AUD_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_C
for delete on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_C
for insert on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_C
for update on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION before insert
on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_CODE_DESIGNATION_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESIGNATION
    select GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESIGNATION.NEXTVAL INTO :new.ALLELE_CODE_DESIGNATION_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_C
for delete on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_C
for insert on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_C
for update on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION_AU before insert
on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_AUD for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_CODE_DESGNTN_AUD_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESGNTN_AUD
    select GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESGNTN_AUD.NEXTVAL INTO :new.ALLELE_CODE_DESGNTN_AUD_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_C
for delete on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_RELT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_C
for insert on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_RELT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_C
for update on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_RELT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_CODE_DESIGNATION_RE before insert
on GENOMIC_REF_DATA.ALLELE_CODE_DESIGNATION_RELT for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_CODE_DESGNTN_RELT_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESGNTN_RELT
    select GENOMIC_REF_DATA.SEQ_ALLELE_CODE_DESGNTN_RELT.NEXTVAL INTO :new.ALLELE_CODE_DESGNTN_RELT_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_G
for delete on GENOMIC_REF_DATA.ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_G
for insert on GENOMIC_REF_DATA.ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_G
for update on GENOMIC_REF_DATA.ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_GROUP before insert
on GENOMIC_REF_DATA.ALLELE_GROUP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_GROUP
    select GENOMIC_REF_DATA.SEQ_ALLELE_GROUP.NEXTVAL INTO :new.ALLELE_GROUP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_N
for delete on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_N
for insert on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_N
for update on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_NUCLEOTIDE_SEQUENCE before insert
on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_NUCLEOTIDE_SEQ_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_NUCLEOTIDE_SEQ
    select GENOMIC_REF_DATA.SEQ_ALLELE_NUCLEOTIDE_SEQ.NEXTVAL INTO :new.ALLELE_NUCLEOTIDE_SEQ_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_N
for delete on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_N
for insert on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_N
for update on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_NUCLEOTIDE_SEQUENCE before insert
on GENOMIC_REF_DATA.ALLELE_NUCLEOTIDE_SEQUENCE_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_NUCLEOTIDE_SEQ_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_NUCLEOTIDE_SEQ_STG
    select GENOMIC_REF_DATA.SEQ_ALLELE_NUCLEOTIDE_SEQ_STG.NEXTVAL INTO :new.ALLELE_NUCLEOTIDE_SEQ_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_R
for delete on GENOMIC_REF_DATA.ALLELE_REJECTION_REASON_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_R
for insert on GENOMIC_REF_DATA.ALLELE_REJECTION_REASON_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_R
for update on GENOMIC_REF_DATA.ALLELE_REJECTION_REASON_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_REJECTION_REASON_ST before insert
on GENOMIC_REF_DATA.ALLELE_REJECTION_REASON_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_REJECTION_REASON_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_REJECT_REASON
    select GENOMIC_REF_DATA.SEQ_ALLELE_REJECT_REASON.NEXTVAL INTO :new.ALLELE_REJECTION_REASON_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_R
for delete on GENOMIC_REF_DATA.ALLELE_REJECTION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_R
for insert on GENOMIC_REF_DATA.ALLELE_REJECTION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_R
for update on GENOMIC_REF_DATA.ALLELE_REJECTION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_REJECTION_STG before insert
on GENOMIC_REF_DATA.ALLELE_REJECTION_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_REJECTION_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_REJECTION_STG
    select GENOMIC_REF_DATA.SEQ_ALLELE_REJECTION_STG.NEXTVAL INTO :new.ALLELE_REJECTION_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_R
for delete on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_R
for insert on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_R
for update on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_RELATIONSHIP before insert
on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_RELATIONSHIP_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP
    select GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP.NEXTVAL INTO :new.ALLELE_RELATIONSHIP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_R
for delete on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_R
for insert on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_R
for update on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_RELATIONSHIP_STG before insert
on GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_RELATIONSHIP_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP_STG
    select GENOMIC_REF_DATA.SEQ_ALLELE_RELATIONSHIP_STG.NEXTVAL INTO :new.ALLELE_RELATIONSHIP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_ALLELE_S
for delete on GENOMIC_REF_DATA.ALLELE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_ALLELE_S
for insert on GENOMIC_REF_DATA.ALLELE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_ALLELE_S
for update on GENOMIC_REF_DATA.ALLELE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_ALLELE_STG before insert
on GENOMIC_REF_DATA.ALLELE_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ALLELE_IID" uses sequence GENOMIC_REF_DATA.SEQ_ALLELE_STG
    select GENOMIC_REF_DATA.SEQ_ALLELE_STG.NEXTVAL INTO :new.ALLELE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_BEHAVIOR
for delete on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_EXPANSION_NAME compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_BEHAVIOR
for insert on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_EXPANSION_NAME compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_BEHAVIOR
for update on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_EXPANSION_NAME compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_EXPANSION_ before insert
on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_EXPANSION_NAME for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "BEHAVIOR_ALLELE_EXPAN_NAME_IID" uses sequence GENOMIC_REF_DATA.SEQ_BEHVR_ALLELE_EXPAN_NAME
    select GENOMIC_REF_DATA.SEQ_BEHVR_ALLELE_EXPAN_NAME.NEXTVAL INTO :new.BEHAVIOR_ALLELE_EXPAN_NAME_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_BEHAVIOR
for delete on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_BEHAVIOR
for insert on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_BEHAVIOR
for update on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_GROUP before insert
on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GROUP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "BEHAVIOR_ALLELE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_BEHAVIOR_ALLELE_GROUP
    select GENOMIC_REF_DATA.SEQ_BEHAVIOR_ALLELE_GROUP.NEXTVAL INTO :new.BEHAVIOR_ALLELE_GROUP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_BEHAVIOR
for delete on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_BEHAVIOR
for insert on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_BEHAVIOR
for update on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_BEHAVIOR_ALLELE_GRP_VER_EX before insert
on GENOMIC_REF_DATA.BEHAVIOR_ALLELE_GRP_VER_EXPAN for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "BEHVR_ALLELE_GRP_VER_EXPAN_IID" uses sequence GENOMIC_REF_DATA.SEQ_BEHVR_ALLELE_GRP_VER_EXPAN
    select GENOMIC_REF_DATA.SEQ_BEHVR_ALLELE_GRP_VER_EXPAN.NEXTVAL INTO :new.BEHVR_ALLELE_GRP_VER_EXPAN_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_CURATOR_
for delete on GENOMIC_REF_DATA.CURATOR_DATA compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_CURATOR_
for insert on GENOMIC_REF_DATA.CURATOR_DATA compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_CURATOR_
for update on GENOMIC_REF_DATA.CURATOR_DATA compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA before insert
on GENOMIC_REF_DATA.CURATOR_DATA for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "CURATOR_DATA_IID" uses sequence GENOMIC_REF_DATA.SEQ_CURATED_DATA
    select GENOMIC_REF_DATA.SEQ_CURATED_DATA.NEXTVAL INTO :new.CURATOR_DATA_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_CURATOR_
for delete on GENOMIC_REF_DATA.CURATOR_DATA_NOTIFICATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_CURATOR_
for insert on GENOMIC_REF_DATA.CURATOR_DATA_NOTIFICATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_CURATOR_
for update on GENOMIC_REF_DATA.CURATOR_DATA_NOTIFICATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA_NOTIFICATION before insert
on GENOMIC_REF_DATA.CURATOR_DATA_NOTIFICATION for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "CURATOR_DATA_NOTIFICATION_IID" uses sequence GENOMIC_REF_DATA.SEQ_CURATED_DATA_NOTIFICATION
    select GENOMIC_REF_DATA.SEQ_CURATED_DATA_NOTIFICATION.NEXTVAL INTO :new.CURATOR_DATA_NOTIFICATION_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_CURATOR_
for delete on GENOMIC_REF_DATA.CURATOR_DATA_RELEASE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_CURATOR_
for insert on GENOMIC_REF_DATA.CURATOR_DATA_RELEASE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_CURATOR_
for update on GENOMIC_REF_DATA.CURATOR_DATA_RELEASE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_CURATOR_DATA_RELEASE before insert
on GENOMIC_REF_DATA.CURATOR_DATA_RELEASE for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "CURATOR_DATA_RELEASE_IID" uses sequence GENOMIC_REF_DATA.SEQ_CURATED_DATA_RELEASE
    select GENOMIC_REF_DATA.SEQ_CURATED_DATA_RELEASE.NEXTVAL INTO :new.CURATOR_DATA_RELEASE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_EXPR_CHA
for delete on GENOMIC_REF_DATA.EXPR_CHAR_SET compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_EXPR_CHA
for insert on GENOMIC_REF_DATA.EXPR_CHAR_SET compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_EXPR_CHA
for update on GENOMIC_REF_DATA.EXPR_CHAR_SET compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_EXPR_CHAR_SET before insert
on GENOMIC_REF_DATA.EXPR_CHAR_SET for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "EXPR_CHAR_SET_IID" uses sequence GENOMIC_REF_DATA.SEQ_EXPR_CHAR_SET
    select GENOMIC_REF_DATA.SEQ_EXPR_CHAR_SET.NEXTVAL INTO :new.EXPR_CHAR_SET_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_EXPR_CHA
for delete on GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_EXPR_CHA
for insert on GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_EXPR_CHA
for update on GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_EXPR_CHAR_SET_VER_MEMBER before insert
on GENOMIC_REF_DATA.EXPR_CHAR_SET_VER_MEMBER for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "EXPR_CHAR_SET_VER_MBR_IID" uses sequence GENOMIC_REF_DATA.SEQ_EXPR_CHAR_SET_VER_MBR
    select GENOMIC_REF_DATA.SEQ_EXPR_CHAR_SET_VER_MBR.NEXTVAL INTO :new.EXPR_CHAR_SET_VER_MBR_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENE_LOC
for delete on GENOMIC_REF_DATA.GENE_LOCUS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENE_LOC
for insert on GENOMIC_REF_DATA.GENE_LOCUS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENE_LOC
for update on GENOMIC_REF_DATA.GENE_LOCUS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENE_LOCUS before insert
on GENOMIC_REF_DATA.GENE_LOCUS for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOME_D
for delete on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOME_D
for insert on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOME_D
for update on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOME_DATABASE_VERSION before insert
on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GENOME_DATABASE_VER_IID" uses sequence GENOMIC_REF_DATA.SEQ_GENOME_DATABASE_VERSION
    select GENOMIC_REF_DATA.SEQ_GENOME_DATABASE_VERSION.NEXTVAL INTO :new.GENOME_DATABASE_VER_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOME_D
for delete on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOME_D
for insert on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOME_D
for update on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOME_DATABASE_VERSION_ST before insert
on GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GENOME_DATABASE_VER_IID" uses sequence GENOMIC_REF_DATA.SEQ_GENOME_DATABASE_VER_STG
    select GENOMIC_REF_DATA.SEQ_GENOME_DATABASE_VER_STG.NEXTVAL INTO :new.GENOME_DATABASE_VER_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOMIC_
for delete on GENOMIC_REF_DATA.GENOMIC_REF_DATA_CONFIGURATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOMIC_
for insert on GENOMIC_REF_DATA.GENOMIC_REF_DATA_CONFIGURATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOMIC_
for update on GENOMIC_REF_DATA.GENOMIC_REF_DATA_CONFIGURATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOMIC_REF_DATA_CONFIGURA before insert
on GENOMIC_REF_DATA.GENOMIC_REF_DATA_CONFIGURATION for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GENOMIC_REF_DATA_CONFIG_IID" uses sequence GENOMIC_REF_DATA.SEQ_GEN_REF_DATA_CONFIG
    select GENOMIC_REF_DATA.SEQ_GEN_REF_DATA_CONFIG.NEXTVAL INTO :new.GENOMIC_REF_DATA_CONFIG_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOMIC_
for delete on GENOMIC_REF_DATA.GENOMIC_REF_OBJ_LEGACY_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOMIC_
for insert on GENOMIC_REF_DATA.GENOMIC_REF_OBJ_LEGACY_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOMIC_
for update on GENOMIC_REF_DATA.GENOMIC_REF_OBJ_LEGACY_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOMIC_REF_OBJ_LEGACY_XRE before insert
on GENOMIC_REF_DATA.GENOMIC_REF_OBJ_LEGACY_XREF for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GEN_REF_OBJ_LEGACY_XREF_IID" uses sequence GENOMIC_REF_DATA.SEQ_GEN_REF_OBJ_LGCY_XREF
    select GENOMIC_REF_DATA.SEQ_GEN_REF_OBJ_LGCY_XREF.NEXTVAL INTO :new.GEN_REF_OBJ_LEGACY_XREF_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOTYPE
for delete on GENOMIC_REF_DATA.GENOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOTYPE
for insert on GENOMIC_REF_DATA.GENOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOTYPE
for update on GENOMIC_REF_DATA.GENOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOTYPE before insert
on GENOMIC_REF_DATA.GENOTYPE for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GENOTYPE_IID" uses sequence GENOMIC_REF_DATA.SEQ_GENOTYPE
    select GENOMIC_REF_DATA.SEQ_GENOTYPE.NEXTVAL INTO :new.GENOTYPE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GENOTYPE
for delete on GENOMIC_REF_DATA.GENOTYPE_LIST compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GENOTYPE
for insert on GENOMIC_REF_DATA.GENOTYPE_LIST compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GENOTYPE
for update on GENOMIC_REF_DATA.GENOTYPE_LIST compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GENOTYPE_LIST before insert
on GENOMIC_REF_DATA.GENOTYPE_LIST for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GENOTYPE_LIST_IID" uses sequence GENOMIC_REF_DATA.SEQ_GENOTYPE_LIST
    select GENOMIC_REF_DATA.SEQ_GENOTYPE_LIST.NEXTVAL INTO :new.GENOTYPE_LIST_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GROUP_MI
for delete on GENOMIC_REF_DATA.GROUP_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GROUP_MI
for insert on GENOMIC_REF_DATA.GROUP_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GROUP_MI
for update on GENOMIC_REF_DATA.GROUP_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GROUP_MISMATCH before insert
on GENOMIC_REF_DATA.GROUP_MISMATCH for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GROUP_MISMATCH_IID" uses sequence GENOMIC_REF_DATA.SEQ_GROUP_MISMATCH
    select GENOMIC_REF_DATA.SEQ_GROUP_MISMATCH.NEXTVAL INTO :new.GROUP_MISMATCH_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_GROUP_MI
for delete on GENOMIC_REF_DATA.GROUP_MISMATCH_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_GROUP_MI
for insert on GENOMIC_REF_DATA.GROUP_MISMATCH_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_GROUP_MI
for update on GENOMIC_REF_DATA.GROUP_MISMATCH_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_GROUP_MISMATCH_MEMBER before insert
on GENOMIC_REF_DATA.GROUP_MISMATCH_MEMBER for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "GROUP_MISMATCH_MEMBER_IID" uses sequence GENOMIC_REF_DATA.SEQ_GROUP_MISMATCH_MBR
    select GENOMIC_REF_DATA.SEQ_GROUP_MISMATCH_MBR.NEXTVAL INTO :new.GROUP_MISMATCH_MEMBER_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_HAPLOTYP
for delete on GENOMIC_REF_DATA.HAPLOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_HAPLOTYP
for insert on GENOMIC_REF_DATA.HAPLOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_HAPLOTYP
for update on GENOMIC_REF_DATA.HAPLOTYPE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_HAPLOTYPE before insert
on GENOMIC_REF_DATA.HAPLOTYPE for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "HAPLOTYPE_IID" uses sequence GENOMIC_REF_DATA.SEQ_HAPLOTYPE
    select GENOMIC_REF_DATA.SEQ_HAPLOTYPE.NEXTVAL INTO :new.HAPLOTYPE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_NOMENCLA
for delete on GENOMIC_REF_DATA.NOMENCLATURE_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_NOMENCLA
for insert on GENOMIC_REF_DATA.NOMENCLATURE_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_NOMENCLA
for update on GENOMIC_REF_DATA.NOMENCLATURE_MISMATCH compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_NOMENCLATURE_MISMATCH before insert
on GENOMIC_REF_DATA.NOMENCLATURE_MISMATCH for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "NOMENCLATURE_MISMATCH_IID" uses sequence GENOMIC_REF_DATA.SEQ_NOMENCLATURE_MISMATCH
    select GENOMIC_REF_DATA.SEQ_NOMENCLATURE_MISMATCH.NEXTVAL INTO :new.NOMENCLATURE_MISMATCH_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_NOM_FILE
for delete on GENOMIC_REF_DATA.NOM_FILE_GROUP_MEMBER_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_NOM_FILE
for insert on GENOMIC_REF_DATA.NOM_FILE_GROUP_MEMBER_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_NOM_FILE
for update on GENOMIC_REF_DATA.NOM_FILE_GROUP_MEMBER_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_NOM_FILE_GROUP_MEMBER_STG before insert
on GENOMIC_REF_DATA.NOM_FILE_GROUP_MEMBER_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "NOM_FILE_GROUP_MEMBER_IID" uses sequence GENOMIC_REF_DATA.SEQ_NOM_FILE_GRP_MBR_STG
    select GENOMIC_REF_DATA.SEQ_NOM_FILE_GRP_MBR_STG.NEXTVAL INTO :new.NOM_FILE_GROUP_MEMBER_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_NOM_FILE
for delete on GENOMIC_REF_DATA.NOM_FILE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_NOM_FILE
for insert on GENOMIC_REF_DATA.NOM_FILE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_NOM_FILE
for update on GENOMIC_REF_DATA.NOM_FILE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_NOM_FILE_GROUP_STG before insert
on GENOMIC_REF_DATA.NOM_FILE_GROUP_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "NOM_FILE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_NOM_FILE_GROUP_STG
    select GENOMIC_REF_DATA.SEQ_NOM_FILE_GROUP_STG.NEXTVAL INTO :new.NOM_FILE_GROUP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_CITATION before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_CITATION_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_CITATION
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_CITATION.NEXTVAL INTO :new.PUBLISHED_ALLELE_CITATION_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_CITATION_ before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_CITATION_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_CITATION_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_CITATION_STG
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_CITATION_STG.NEXTVAL INTO :new.PUBLISHED_ALLELE_CITATION_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_FEATURE before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_FEATURE_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBLISHED_ALLELE_FEATURE
    select GENOMIC_REF_DATA.SEQ_PUBLISHED_ALLELE_FEATURE.NEXTVAL INTO :new.PUBLISHED_ALLELE_FEATURE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_FEATURE_S before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_FEATURE_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_FEATURE_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_FEATURE_STG
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_FEATURE_STG.NEXTVAL INTO :new.PUBLISHED_ALLELE_FEATURE_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_GROUP before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBLISHED_ALLELE_GROUP
    select GENOMIC_REF_DATA.SEQ_PUBLISHED_ALLELE_GROUP.NEXTVAL INTO :new.PUBLISHED_ALLELE_GROUP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_GROUP_STG before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_GROUP_STG
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_GROUP_STG.NEXTVAL INTO :new.PUBLISHED_ALLELE_GROUP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SOURCE_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SOURCE_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SOURCE_XREF compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SOURCE_XR before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SOURCE_XREF for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_SRC_XREF_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SOURCE_XREF
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SOURCE_XREF.NEXTVAL INTO :new.PUBLISHED_ALLELE_SRC_XREF_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_MATERIAL compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_MATERIAL compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_MATERIAL compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SRC_MATER before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_MATERIAL for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBL_ALLELE_SRC_MATERIAL_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_MATERIAL
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_MATERIAL.NEXTVAL INTO :new.PUBL_ALLELE_SRC_MATERIAL_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBLISHE
for delete on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_XREF_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBLISHE
for insert on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_XREF_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBLISHE
for update on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_XREF_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBLISHED_ALLELE_SRC_XREF_ before insert
on GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_XREF_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBLISHED_ALLELE_SRC_XREF_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_XREF_STG
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_XREF_STG.NEXTVAL INTO :new.PUBLISHED_ALLELE_SRC_XREF_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBL_ALL
for delete on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MBR_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBL_ALL
for insert on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MBR_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBL_ALL
for update on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MBR_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GROUP_VER_MBR_ before insert
on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MBR_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBL_ALL
for delete on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBL_ALL
for insert on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBL_ALL
for update on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MEMBER compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GROUP_VER_MEMB before insert
on GENOMIC_REF_DATA.PUBL_ALLELE_GROUP_VER_MEMBER for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBL_ALL
for delete on GENOMIC_REF_DATA.PUBL_ALLELE_GRP_VER_MBR_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBL_ALL
for insert on GENOMIC_REF_DATA.PUBL_ALLELE_GRP_VER_MBR_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBL_ALL
for update on GENOMIC_REF_DATA.PUBL_ALLELE_GRP_VER_MBR_AUD compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_GRP_VER_MBR_AU before insert
on GENOMIC_REF_DATA.PUBL_ALLELE_GRP_VER_MBR_AUD for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBL_GRP_VER_MBR_AUD_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_GRP_VER_MBR_AUD
    select GENOMIC_REF_DATA.SEQ_PUBL_GRP_VER_MBR_AUD.NEXTVAL INTO :new.PUBL_GRP_VER_MBR_AUD_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_PUBL_ALL
for delete on GENOMIC_REF_DATA.PUBL_ALLELE_SRC_MATERIAL_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_PUBL_ALL
for insert on GENOMIC_REF_DATA.PUBL_ALLELE_SRC_MATERIAL_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_PUBL_ALL
for update on GENOMIC_REF_DATA.PUBL_ALLELE_SRC_MATERIAL_STG compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_PUBL_ALLELE_SRC_MATERIAL_S before insert
on GENOMIC_REF_DATA.PUBL_ALLELE_SRC_MATERIAL_STG for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "PUBL_ALLELE_SRC_MATERIAL_IID" uses sequence GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_MATRL_STG
    select GENOMIC_REF_DATA.SEQ_PUBL_ALLELE_SRC_MATRL_STG.NEXTVAL INTO :new.PUBL_ALLELE_SRC_MATERIAL_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_SEARCH_D
for delete on GENOMIC_REF_DATA.SEARCH_DETERMINANT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_SEARCH_D
for insert on GENOMIC_REF_DATA.SEARCH_DETERMINANT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_SEARCH_D
for update on GENOMIC_REF_DATA.SEARCH_DETERMINANT compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_SEARCH_DETERMINANT before insert
on GENOMIC_REF_DATA.SEARCH_DETERMINANT for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "SEARCH_DETERMINANT_IID" uses sequence GENOMIC_REF_DATA.SEQ_SEARCH_DETERMINANT
    select GENOMIC_REF_DATA.SEQ_SEARCH_DETERMINANT.NEXTVAL INTO :new.SEARCH_DETERMINANT_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_SEARCH_D
for delete on GENOMIC_REF_DATA.SEARCH_DETERMINANT_RLTSHP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_SEARCH_D
for insert on GENOMIC_REF_DATA.SEARCH_DETERMINANT_RLTSHP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_SEARCH_D
for update on GENOMIC_REF_DATA.SEARCH_DETERMINANT_RLTSHP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_SEARCH_DETERMINANT_RLTSHP before insert
on GENOMIC_REF_DATA.SEARCH_DETERMINANT_RLTSHP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "SRCH_DTRM_RELATIONSHIP_IID" uses sequence GENOMIC_REF_DATA.SEQ_SRCH_DTRM_RELATIONSHIP
    select GENOMIC_REF_DATA.SEQ_SRCH_DTRM_RELATIONSHIP.NEXTVAL INTO :new.SRCH_DTRM_RELATIONSHIP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_SEROLOGY
for delete on GENOMIC_REF_DATA.SEROLOGY compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_SEROLOGY
for insert on GENOMIC_REF_DATA.SEROLOGY compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_SEROLOGY
for update on GENOMIC_REF_DATA.SEROLOGY compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_SEROLOGY before insert
on GENOMIC_REF_DATA.SEROLOGY for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "SEROLOGY_IID" uses sequence GENOMIC_REF_DATA.SEQ_SEROLOGY
    select GENOMIC_REF_DATA.SEQ_SEROLOGY.NEXTVAL INTO :new.SEROLOGY_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_TEST_RES
for delete on GENOMIC_REF_DATA.TEST_RESULT_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_TEST_RES
for insert on GENOMIC_REF_DATA.TEST_RESULT_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_TEST_RES
for update on GENOMIC_REF_DATA.TEST_RESULT_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_TEST_RESULT_ALLELE_GROUP before insert
on GENOMIC_REF_DATA.TEST_RESULT_ALLELE_GROUP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "TEST_RESULT_ALLELE_GRP_IID" uses sequence GENOMIC_REF_DATA.SEQ_TEST_RESULT_ALLELE_GRP
    select GENOMIC_REF_DATA.SEQ_TEST_RESULT_ALLELE_GRP.NEXTVAL INTO :new.TEST_RESULT_ALLELE_GRP_IID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_USERS
for delete on GENOMIC_REF_DATA.USERS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_USERS
for insert on GENOMIC_REF_DATA.USERS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_USERS
for update on GENOMIC_REF_DATA.USERS compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_USERS before insert
on GENOMIC_REF_DATA.USERS for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "ID" uses sequence GENOMIC_REF_DATA.SEQ_USERS
    select GENOMIC_REF_DATA.SEQ_USERS.NEXTVAL INTO :new.ID from dual;
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDDELETETRIGGER_XX_ALLEL
for delete on GENOMIC_REF_DATA.XX_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDINSERTTRIGGER_XX_ALLEL
for insert on GENOMIC_REF_DATA.XX_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create or replace trigger GENOMIC_REF_DATA.COMPOUNDUPDATETRIGGER_XX_ALLEL
for update on GENOMIC_REF_DATA.XX_ALLELE_GROUP compound trigger
// Declaration
// Body
  before statement is
  begin
...
create trigger GENOMIC_REF_DATA.TIB_XX_ALLELE_GROUP before insert
on GENOMIC_REF_DATA.XX_ALLELE_GROUP for each row
declare
    integrity_error  exception;
    errno            integer;
    errmsg           char(200);
...
begin
    --  Column "XX_ALLELE_GROUP_IID" uses sequence GENOMIC_REF_DATA.SEQ_XX_ALLELE_GROUP
    select GENOMIC_REF_DATA.SEQ_XX_ALLELE_GROUP.NEXTVAL INTO :new.XX_ALLELE_GROUP_IID from dual;
