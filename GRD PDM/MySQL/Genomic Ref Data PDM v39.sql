/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     10/6/2016 9:25:33 PM                         */
/*==============================================================*/


drop table if exists GENOMIC_REF_DATA.ALLELE;

drop table if exists GENOMIC_REF_DATA.ALLELE_ANNOTATION;

drop table if exists GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF;

drop table if exists GENOMIC_REF_DATA.ALLELE_ANNOTATION_TYPE;
...
drop table if exists GENOMIC_REF_DATA.COMMON_WELL_DOC_STATUS_STG;

drop table if exists GENOMIC_REF_DATA.GENE_FAMILY;

drop table if exists GENOMIC_REF_DATA.GENE_FAMILY_STG;

drop table if exists GENOMIC_REF_DATA.GENE_LOCUS;

drop table if exists GENOMIC_REF_DATA.GENE_LOCUS_STG;
...
drop table if exists GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION;

drop table if exists GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION_STG;
...
drop table if exists GENOMIC_REF_DATA.MHC_CLASSIFICATION_STG;
...
drop table if exists GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_VERSIO3;
...
/*==============================================================*/
/* Table: ALLELE_ANNOTATION                                     */
/*==============================================================*/
create table GENOMIC_REF_DATA.ALLELE_ANNOTATION
(
   ALLELE_ANNOTATION_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific relationship between an Allele and an Annotation.  ',
   ALLELE_IID           numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  ',
   ANNOTATION_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific annotation that can be applied to an allele within the Enterprise.  ',
   GENOME_DATABASE_VER_IID numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents a genome database version within the Enterprise.  ',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (ALLELE_ANNOTATION_IID),
   key AK_ALLELE_ANNOTATION (ALLELE_IID, ANNOTATION_IID, GENOME_DATABASE_VER_IID)
);

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION comment 'A unique combination of a specific Allele to a specific Alle';

/*==============================================================*/
/* Table: ALLELE_ANNOTATION_DEF                                 */
/*==============================================================*/
create table GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF
(
   ANNOTATION_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific annotation that can be applied to an allele within the Enterprise.  ',
   ANNOTATION_CDE       varchar(10) not null comment 'A valid value to represent a specific kind of annotation can be applied to alleles; these values are always defined within the context of a particular type  (e.g. N = Null, A = Aberrant, Q = Questionable are examples of values within the annotation type = Expression Characters.',
   ANNOTATION_NME       varchar(50) not null comment 'A textual ''label'' or name (that corresponds to a valid code) by which an Annotation is known/can be recognized',
   ANNOTATION_TYPE_CDE  varchar(10) not null comment 'A valid value to represent a specific kind of annotation type that can be applied to alleles (e.g. ?? = Expression Characters, [need examples of other kinds of annotations])',
   ...
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (ANNOTATION_IID),
   key AK_ALLELE_ANNOTATION_DEF (ANNOTATION_CDE, ANNOTATION_TYPE_CDE, GENE_FAMILY_CDE)
);

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF comment 'The valid values for Annotations that can be associated/link';

/*==============================================================*/
/* Table: ALLELE_ANNOTATION_TYPE                                */
/*==============================================================*/
create table GENOMIC_REF_DATA.ALLELE_ANNOTATION_TYPE
(
   ANNOTATION_TYPE_CDE  varchar(10) not null comment 'A valid value to represent a specific kind of annotation type that can be applied to alleles (e.g. ?? = Expression Characters, [need examples of other kinds of annotations])',
   ANNOTATION_TYPE_NME  varchar(50) not null comment 'A textual ''label'' or name (that corresponds to a valid code) by which an AnnotationType is known/can be recognized',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (ANNOTATION_TYPE_CDE),
   key AK_ALLELE_ANNOTATION_TYPE (ANNOTATION_TYPE_NME)
);

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_TYPE comment 'A particular kind or classification of Annotations that prov';
...
(
   ...
   primary key (ALLELE_IID, CHANGE_TS)
);
...
(
   ...
   CHANGE_TYPE_CDE      varchar(10) not null comment 'The type of change made to the record.  U= Update (001), I = Insert (002) , D = Delete (003).  Legacy values are in parenthesis',
   CHANGE_BY_ID         varchar(50) not null,
   primary key (ALLELE_CODE_DESIGNATION_IID, CHANGE_TS)
);
...
(
   ALLELE_COMMON_WELL_DOC_IID numeric(9,0) not null,
   ALLELE_IID           numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  ',
   ...
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (ALLELE_COMMON_WELL_DOC_IID),
   key AK_ALLELE_COMMON_WELL_DOCUMENTED (ALLELE_IID, COMMON_WELL_DOC_STATUS_CDE, COMMON_WELL_DOC_VER_NUM)
);
...
(
   ...
   CHANGE_TYPE_CDE      varchar(10) not null comment 'The type of change made to the record.  U= Update (001), I = Insert (002) , D = Delete (003).  Legacy values are in parenthesis',
   CHANGE_BY_ID         varchar(50) not null,
   primary key (BEHAVIOR_ALLELE_GROUP_IID, ALLELE_IID, CHANGE_TS)
);
...
(
   ...
   key AK_COMMON_WELL_DOCUMENTED_STATUS (COMMON_WELL_DOC_STATUS_NME)
);

/*==============================================================*/
/* Table: COMMON_WELL_DOC_STATUS_STG                            */
/*==============================================================*/
create table GENOMIC_REF_DATA.COMMON_WELL_DOC_STATUS_STG
(
   COMMON_WELL_DOC_STATUS_CDE varchar(20) not null,
   COMMON_WELL_DOC_STATUS_NME varchar(50) not null,
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
...
/*==============================================================*/
/* Table: GENE_FAMILY_STG                                       */
/*==============================================================*/
create table GENOMIC_REF_DATA.GENE_FAMILY_STG
(
   GENE_FAMILY_CDE      varchar(10) not null comment 'A valid value to represent a specific kind of gene system/family (e.g. HLA = Human Leukocyte Antigen, KIR = Killer Immunoglobin Receptor, CCR = C-C Chemokine Receptor, ABO = ??, etc.)',
   GENE_FAMILY_NME      varchar(50) not null comment 'The description for a given gene family.  For example for HLA the description is Human Leukocyte Antigen',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
...
alter table GENOMIC_REF_DATA.GENE_FAMILY_STG comment 'The sets of Genes that NMDP concerns itself with.  As of May';
...
/*==============================================================*/
/* Table: GENE_LOCUS_STG                                        */
/*==============================================================*/
create table GENOMIC_REF_DATA.GENE_LOCUS_STG
(
   GENE_LOCUS_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a gene locus within the Enterprise.  ',
   GENE_LOCUS_LONG_NME  varchar(50) not null comment 'A comprehensive textual ''label'' or name (that corresponds to a valid code) by which a Gene Locus is known/can be recognized; For example HLA-A would be considered a long/comprehensive name, where A would be considered the short name (always within the context of the Gene Family)
            ',
...
alter table GENOMIC_REF_DATA.GENE_LOCUS_STG comment 'The valid value of Gene Locus within a given Gene Family.  E';
...
(
   GENOME_DATABASE_VER_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a genome database version within the Enterprise.  ',
   GENE_FAMILY_CDE      varchar(10) not null comment 'A valid value to represent a specific kind of gene system/family (e.g. HLA = Human Leukocyte Antigen, KIR = Killer Immunoglobin Receptor, CCR = C-C Chemokine Receptor, ABO = ??, etc.)',
   DATABASE_VERSION_TXT varchar(2000) not null comment 'The name given to a published database. the name has historically followed the following pattern: <major release number>.<minor release number>.<patch/correction> the name is established by committee',
   ...
   DATABASE_VER_PUBLISHED_URL varchar(256) not null comment 'The Link to an HTML site for Published ??Allelles??',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
...
/*==============================================================*/
/* Table: GENOMIC_ALLELE_ACCESSION                              */
/*==============================================================*/
create table GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION
(
   GENOMIC_ALLELE_ACCESSION_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a genome allele accession ''record'' within the Enterprise.  ',
   GENE_LOCUS_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a gene locus within the Enterprise.  ',
   ...
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (GENOMIC_ALLELE_ACCESSION_IID),
   key AK_GENOMIC_ALLELE_ACCESSION (GENE_LOCUS_IID, ACCESSION_NUM)
);

alter table GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION comment 'Legacy Name:  who_allele and t_pa.

The combinat';

/*==============================================================*/
/* Table: GENOMIC_ALLELE_ACCESSION_STG                          */
/*==============================================================*/
create table GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION_STG
(
   GENOMIC_ALLELE_ACCESSION_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a genome allele accession ''record'' within the Enterprise.  ',
   GENE_LOCUS_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a gene locus within the Enterprise.  ',
   ACCESSION_NUM        varchar(20) not null comment 'A unique identifier showing a progression of allele discoveries per locus; the accession number is independent of any database version and will likely be unique ONLY within the context of a specific source or curator.',
...
alter table GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION_STG comment 'Legacy Name:  who_allele and t_pa.
...
(
   ...
   key AK_GENOMIC_REFERENCE_OBJECT (MHC_CLASSIFICATION_NME)
);

alter table GENOMIC_REF_DATA.MHC_CLASSIFICATION comment 'Major Histocompatibility Complex (MHC) Classification is app';

/*==============================================================*/
/* Table: MHC_CLASSIFICATION_STG                                */
/*==============================================================*/
create table GENOMIC_REF_DATA.MHC_CLASSIFICATION_STG
(
   MHC_CLASSIFICATION_CDE varchar(2) not null comment 'A valid value to represent a specific kind of MHC classification (applicable ONLY to the HLA Gene Family) (e.g. I = Class I, II = Class II)',
   MHC_CLASSIFICATION_NME varchar(50) not null comment 'A textual ''label'' or name (that corresponds to a valid code) by which an MHC Classification is known/can be recognized',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
...
alter table GENOMIC_REF_DATA.MHC_CLASSIFICATION_STG comment 'Major Histocompatibility Complex (MHC) Classification is app';
...
/*==============================================================*/
/* Table: PUBLISHED_ALLELE_GROUP_VERSIO3                        */
/*==============================================================*/
create table GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_VERSIO3
(
   PUBLISHED_ALLELE_GROUP_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a published allele group (as curated) within the Enterprise.  ',
   GENOME_DATABASE_VER_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a genome database version within the Enterprise.  ',
   CHANGE_TS            timestamp not null,
   ...
   CHANGE_TYPE_CDE      varchar(10) not null comment 'The type of change made to the record.  U= Update (001), I = Insert (002) , D = Delete (003).  Legacy values are in parenthesis',
   CHANGE_BY_ID         varchar(50) not null,
   primary key (PUBLISHED_ALLELE_GROUP_IID, GENOME_DATABASE_VER_IID, CHANGE_TS)
);

alter table GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_VERSIO3 comment 'The linkage between a published allele group (e.g. P or G gr';
...
(
   ...
   CHANGE_TYPE_CDE      varchar(10) not null comment 'The type of change made to the record.  U= Update (001), I = Insert (002) , D = Delete (003).  Legacy values are in parenthesis',
   CHANGE_BY_ID         varchar(50) not null,
   primary key (XX_ALLELE_GROUP_IID, ALLELE_IID, CHANGE_TS)
);
...
alter table GENOMIC_REF_DATA.ALLELE add constraint FK_ALLELE_02 foreign key (GENOMIC_ALLELE_ACCESSION_IID)
      references GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION (GENOMIC_ALLELE_ACCESSION_IID) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION add constraint FK_ALLELE_ANNOTATION_01 foreign key (ANNOTATION_IID)
      references GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF (ANNOTATION_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION add constraint FK_ALLELE_ANNOTATION_02 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION (GENOME_DATABASE_VER_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION add constraint FK_ALLELE_ANNOTATION_03 foreign key (ALLELE_IID)
      references GENOMIC_REF_DATA.ALLELE (ALLELE_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF add constraint FK_ALLELE_ANNOTATION_DEF_01 foreign key (ANNOTATION_TYPE_CDE)
      references GENOMIC_REF_DATA.ALLELE_ANNOTATION_TYPE (ANNOTATION_TYPE_CDE) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_DEF add constraint FK_ALLELE_ANNOTATION_DEF_02 foreign key (GENE_FAMILY_CDE)
...
alter table GENOMIC_REF_DATA.ALLELE_COMMON_WELL_DOC_STG add constraint FK_ALLELE_CWD_STG_02 foreign key (COMMON_WELL_DOC_STATUS_CDE)
      references GENOMIC_REF_DATA.COMMON_WELL_DOC_STATUS_STG (COMMON_WELL_DOC_STATUS_CDE) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_REASON add constraint FK_ALLELE_RELATIONSHIP_04 foreign key (ALLELE_RELATIONSHIP_REASON_IID)
...
alter table GENOMIC_REF_DATA.ALLELE_RELATIONSHIP_REASON add constraint FK_REFERENCE_140 foreign key (ALLELE_RELATIONSHIP_IID)
...
alter table GENOMIC_REF_DATA.ALLELE_STG add constraint FK_ALLELE_STG_01 foreign key (GENE_LOCUS_IID)
      references GENOMIC_REF_DATA.GENE_LOCUS_STG (GENE_LOCUS_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.ALLELE_STG add constraint FK_ALLELE_STG_02 foreign key (GENOMIC_ALLELE_ACCESSION_IID)
      references GENOMIC_REF_DATA.GENOMIC_ALLELE_ACCESSION_STG (GENOMIC_ALLELE_ACCESSION_IID) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.GENE_LOCUS_STG add constraint FK_GENE_LOCUS_STG_01 foreign key (GENE_FAMILY_CDE)
      references GENOMIC_REF_DATA.GENE_FAMILY_STG (GENE_FAMILY_CDE) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.GENE_LOCUS_STG add constraint FK_GENE_LOCUS_STG_02 foreign key (EFF_GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG (GENOME_DATABASE_VER_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.GENE_LOCUS_STG add constraint FK_GENE_LOCUS_STG_03 foreign key (PREVIOUS_GENE_LOCUS_IID)
      references GENOMIC_REF_DATA.GENE_LOCUS_STG (GENE_LOCUS_IID) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.GENE_LOCUS_STG add constraint FK_GENE_LOCUS_STG_04 foreign key (MHC_CLASSIFICATION_CDE)
      references GENOMIC_REF_DATA.MHC_CLASSIFICATION_STG (MHC_CLASSIFICATION_CDE) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.GENOME_DATABASE_VERSION add constraint FK_GENOME_DATABASE_VER_01 foreign key (GENE_FAMILY_CDE)
      references GENOMIC_REF_DATA.GENE_FAMILY (GENE_FAMILY_CDE) on delete restrict on update restrict;

alter table GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG add constraint FK_GENOME_DATABASE_VER_STG_01 foreign key (GENE_FAMILY_CDE)
      references GENOMIC_REF_DATA.GENE_FAMILY_STG (GENE_FAMILY_CDE) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.PUBLISHED_ALLELE_GROUP_STG add constraint FK_PUBL_ALLELE_GROUP_STG_01 foreign key (GENE_LOCUS_IID)
      references GENOMIC_REF_DATA.GENE_LOCUS_STG (GENE_LOCUS_IID) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.PUBLISHED_ALLELE_SRC_MATERIAL add constraint FK_PUBL_ALLELE_SRC_MATERIAL_02 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION (GENOME_DATABASE_VER_IID) on delete restrict on update restrict;
...
alter table GENOMIC_REF_DATA.PUBL_ALLELE_SRC_MATERIAL_STG add constraint FK_PUBL_ALLELE_SRC_MATL_STG_02 foreign key (GENOME_DATABASE_VER_IID)
      references GENOMIC_REF_DATA.GENOME_DATABASE_VERSION_STG (GENOME_DATABASE_VER_IID) on delete restrict on update restrict;
