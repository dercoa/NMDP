/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     10/11/2016 3:29:17 PM                        */
/*==============================================================*/
...
drop table if exists GENOMIC_REF_DATA.ALLELE_ANNOTATION_STG;
...
/*==============================================================*/
/* Table: ALLELE_ANNOTATION_STG                                 */
/*==============================================================*/
create table GENOMIC_REF_DATA.ALLELE_ANNOTATION_STG
(
   ALLELE_ANNOTATION_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific relationship between an Allele and an Annotation.  ',
   ALLELE_IID           numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  ',
   ANNOTATION_IID       numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific annotation that can be applied to an allele within the Enterprise.  ',
...
alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_STG comment 'A unique combination of a specific Allele to a specific Alle';
...
(
   ...
   key AK_ALLELE_COMMON_WELL_DOC (ALLELE_IID, COMMON_WELL_DOC_STATUS_CDE, COMMON_WELL_DOC_VER_NUM)
);
...
(
   ALLELE_RELATIONSHIP_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a specific relationships between alleles within the Enterprise.  ',
   ALLELE_1_IID         numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  ',
   ALLELE_2_IID         numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents an allele within the Enterprise.  ',
   ALLELE_RELATIONSHIP_TYPE_CDE varchar(10) not null comment 'A valid value to represent a specific kind of relationship that may exists between alleles (e.g. ?? = Replacement - for renamed/deleted situations, ?? = Alternate - for when there are a variation of choices for an allele representation, ?? = Best Match). ',
   ALLELE_RELATIONSHIP_REASON_TXT varchar(100),
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
...
(
   ...
   key AK_PUBLISHED_ALLELE_CITATION (ALLELE_IID, PUB_MED_ID)
);
...
alter table GENOMIC_REF_DATA.ALLELE_ANNOTATION_STG add constraint FK_ALLELE_ANNOTATION_STG_01 foreign key (ALLELE_IID)
