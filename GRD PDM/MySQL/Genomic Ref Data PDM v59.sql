/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     11/7/2016 8:31:35 PM                         */
/*==============================================================*/
...
drop table if exists BEHAVIOR_MODIFIER_OBJECT;

drop table if exists GENOMIC_REF_DATA.BEHAVIOR_MODIFIER_OBJECT_TYPE;
...
/*==============================================================*/
/* Table: BEHAVIOR_MODIFIER_OBJECT                              */
/*==============================================================*/
create table BEHAVIOR_MODIFIER_OBJECT
(
   BEHAVIOR_MODIFIER_OBJECT_IID numeric(9,0) not null comment 'A system generated identifier (surrogate key) that uniquely represents a behavior modifier object record (an abstraction for values representing several distinct concepts such as Expression Characters, Function Characters, etc)',
   BEHAVIOR_MODIFIER_OBJECT_TYPE_CDE varchar(10) comment 'A valid value to represent a particular kind or type of Behavior Modifier Object; valid types may vary by gene family.  Preliminary Values are EXPCHAR = HlLA Expression Characters, and FUNCCHAR = KIR Function Characters',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (BEHAVIOR_MODIFIER_OBJECT_IID)
);

/*==============================================================*/
/* Table: BEHAVIOR_MODIFIER_OBJECT_TYPE                         */
/*==============================================================*/
create table GENOMIC_REF_DATA.BEHAVIOR_MODIFIER_OBJECT_TYPE
(
   BEHAVIOR_MODIFIER_OBJECT_TYPE_CDE varchar(10) not null comment 'A valid value to represent a particular kind or type of Behavior Modifier Object; valid types may vary by gene family.  Preliminary Values are EXPCHAR = HlLA Expression Characters, and FUNCCHAR = KIR Function Characters',
   BEHAVIOR_MODIFIER_OBJECT_TYPE_NME varchar(50) not null comment 'A textual ''label'' or name (that corresponds to a valid code) by which a Genomic Reference Object is known/can be recognized.  For Example, Allele, Allele Code Designation, etc.',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. ',
   primary key (BEHAVIOR_MODIFIER_OBJECT_TYPE_CDE),
   key AK_AK_BEHVR_MODIFIER_OBJ_TYPE (BEHAVIOR_MODIFIER_OBJECT_TYPE_NME)
);
...
(
   ALLELE_CODE_DESIGNATION_IID numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents an Allele Code Designation within the Enterprise.  ',
   TEST_RESULT_ALLELE_GRP_IID numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents a Test Level Allele Group within the Enterprise.  ',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. '
...
(
   ALLELE_CODE_DESIGNATION_IID numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents an Allele Code Designation within the Enterprise.  ',
   XX_ALLELE_GROUP_IID  numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents an XX Group within the Enterprise. ',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. '
...
(
   ...
   ANTIGEN_EID          numeric(9,0) comment 'A system generated identifier (surrogate key) that uniquely represents a legacy (sybase) Antigen record within the Enterprise.  ',
   CREATE_TS            timestamp not null comment 'The record created timestamp in the database',
   CREATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program created the record',
   UPDATE_TS            timestamp not null comment 'The record updated timestamp in the database',
   UPDATE_BY_ID         varchar(50) not null comment 'The user id / unique id of the person / program updated the record. '
...
alter table BEHAVIOR_MODIFIER_OBJECT add constraint FK_BEHAVIOR_MODIFIER_OBJECT_01 foreign key (BEHAVIOR_MODIFIER_OBJECT_TYPE_CDE)
      references GENOMIC_REF_DATA.BEHAVIOR_MODIFIER_OBJECT_TYPE (BEHAVIOR_MODIFIER_OBJECT_TYPE_CDE) on delete restrict on update restrict;
