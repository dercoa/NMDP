...
/* Table: CANCEL_REASON                                         */
/*==============================================================*/
create table TS_ORDER_MGMT.CANCEL_REASON (
   ...
   constraint PK_CANCEL_REASON primary key (CANCEL_REASON_CDE)
         using index tablespace TS_ORDER_MGMT_IDX
)
   tablespace TS_ORDER_MGMT
/

comment on column TS_ORDER_MGMT.CANCEL_REASON.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.CANCEL_REASON.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.CANCEL_REASON.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.CANCEL_REASON.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.CANCEL_REASON to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.CANCEL_REASON to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: CENTRAL_LINE_PLACEMENT                                */
/*==============================================================*/
create table TS_ORDER_MGMT.CENTRAL_LINE_PLACEMENT (
...
comment on table TS_ORDER_MGMT.CENTRAL_LINE_PLACEMENT is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.CENTRAL_LINE_PLACEMENT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.CENTRAL_LINE_PLACEMENT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: CENTRAL_LINE_STATUS                                   */
/*==============================================================*/
create table TS_ORDER_MGMT.CENTRAL_LINE_STATUS (
...
comment on table TS_ORDER_MGMT.CENTRAL_LINE_STATUS is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.CENTRAL_LINE_STATUS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.CENTRAL_LINE_STATUS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: CLOSE_REASON                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.CLOSE_REASON (
...
comment on table TS_ORDER_MGMT.CLOSE_REASON is
...
comment on column TS_ORDER_MGMT.CLOSE_REASON.CLOSE_REASON_CDE is
...
comment on column TS_ORDER_MGMT.CLOSE_REASON.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.CLOSE_REASON.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.CLOSE_REASON.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.CLOSE_REASON.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.CLOSE_REASON to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.CLOSE_REASON to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: CUSTOMER_ORDER_SUBJECT                                */
/*==============================================================*/
create table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT (
   CUSTOMER_ORDER_SUBJECT_IID NUMBER                not null
...
comment on table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT is
...
comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.CUSTOMER_ORDER_SUBJECT_IID is
'PK'
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.SUBJECT_GUID is
'A Global ID of the subject. '
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.PROJECT_CDE is
'Project code for the order. '
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

comment on column TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT.CUSTOMER_BP_GUID is
'Contains the Business Party enterprise ID for the Infusion Center (AUTO orders) or Transplant Center (ALLO orders).'
/

alter table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT
   add constraint AK_CUSTOMER_ORDER_SUBJECT unique (SUBJECT_GUID, ORDER_GUID)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM (
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_COMPONENT                                */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT (
...
comment on table TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT is
'Group of fields which have some interaction between them; a table/row combination.'
/

comment on column TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT.FORM_COMPONENT_TYPE_CDE is
'Values:  
Custom = static HTML
Regular = dynamic HTML'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_FIELD                                    */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD (
...
comment on column TS_ORDER_MGMT.DYNAMIC_FORM_FIELD.FORM_FIELD_KEY_CDE is
'This column will contain the name of the column to get the valid values from.'
/

comment on column TS_ORDER_MGMT.DYNAMIC_FORM_FIELD.FORM_FIELD_LABEL_TXT is
'Display text for the questions.'
/

comment on column TS_ORDER_MGMT.DYNAMIC_FORM_FIELD.FORM_FIELD_NME is
'Universal name for each unique field, across forms.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_FIELD_OPTION                             */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_OPTION (
   FORM_FIELD_OPTION_IID NUMBER                not null
      generated by default as identity ( start with 1),
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_OPTION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_OPTION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_FIELD_TYPE                               */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_TYPE (
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_FIELD_VALUE                              */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_VALUE (
   DYNAMIC_FORM_FIELD_VALUE_IID NUMBER                not null
      generated by default as identity ( start with 1),
   DYNAMIC_FORM_IID     NUMBER                not null,
   FORM_FIELD_IID       NUMBER                not null,
   ORDER_GUID           RAW(16),
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_VALUE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_VALUE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_SECTION                                  */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_SECTION (
   FORM_SECTION_IID     NUMBER                not null
      generated by default as identity ( start with 1),
   DYNAMIC_FORM_IID     NUMBER                not null,
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_SECTION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_SECTION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: DYNAMIC_FORM_TYPE                                     */
/*==============================================================*/
create table TS_ORDER_MGMT.DYNAMIC_FORM_TYPE (
   DYNAMIC_FORM_TYPE_CDE VARCHAR2(10 CHAR)     not null,
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.DYNAMIC_FORM_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.DYNAMIC_FORM_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: FORM_MASTER_LIST                                      */
/*==============================================================*/
create table TS_ORDER_MGMT.FORM_MASTER_LIST (
...
alter table TS_ORDER_MGMT.FORM_MASTER_LIST
   add constraint AK_FORM_MASTER_LIST unique (MASTER_CONTROL_FORM_ID)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.FORM_MASTER_LIST to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.FORM_MASTER_LIST to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: FORM_RESOURCE_ROLE                                    */
/*==============================================================*/
create table TS_ORDER_MGMT.FORM_RESOURCE_ROLE (
   FORM_IID             NUMBER                not null,
...
comment on table TS_ORDER_MGMT.FORM_RESOURCE_ROLE is
'May need to add BP_GUID to this table PK.
'
/

comment on column TS_ORDER_MGMT.FORM_RESOURCE_ROLE.RESOURCE_ROLE_CDE is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.FORM_RESOURCE_ROLE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.FORM_RESOURCE_ROLE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: OPTION_VALUE                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.OPTION_VALUE (
...
comment on table TS_ORDER_MGMT.OPTION_VALUE is
...
comment on column TS_ORDER_MGMT.OPTION_VALUE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.OPTION_VALUE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.OPTION_VALUE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.OPTION_VALUE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.OPTION_VALUE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.OPTION_VALUE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_HEADER                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_HEADER (
...
comment on column TS_ORDER_MGMT.ORDER_HEADER.ORDER_GUID is
...
comment on column TS_ORDER_MGMT.ORDER_HEADER.CM_CASE_IID is
'A unique identifier assigned to a patient and linked to a specific patient via the Subject_GUID.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.ORDER_NUM is
...
comment on column TS_ORDER_MGMT.ORDER_HEADER.ORDER_SUBJECT_GUID is
...
comment on column TS_ORDER_MGMT.ORDER_HEADER.REQUESTER_ID is
'The LDAP User ID of the person who is entering / requesting the Order.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.APPROVER_ID is
'The LDAP User ID of the person who is accepting / approving the Order.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_HEADER.CLOSE_REASON_CDE is
'Reason the order was canceled or reason the donor was released from the patient.  (E.g. CC - Collection complete, CA - cancel request, DD - permanently Deferred, etc. )'
/

alter table TS_ORDER_MGMT.ORDER_HEADER
   add constraint AK_ORDER_HEADER unique (ORDER_NUM)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_HEADER to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_HEADER to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_LINE_ITEM                                       */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_LINE_ITEM (
...
comment on table TS_ORDER_MGMT.ORDER_LINE_ITEM is
...
comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.ORDER_LINE_ITEM_IID is
'PK'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.SERVICE_CDE is
'A code indicating the Service.'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.SEQ_NUM is
'A number to indicate the order of multiple detail rows of the same order item (second Collection, second IDMs, etc)'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.LINKED_ORDER_LINE_ITEM_IID is
'PK'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.CANCEL_REASON_CDE is
'This applies to AUTO as well as therapies may be cancelled.'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_LINE_ITEM.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

alter table TS_ORDER_MGMT.ORDER_LINE_ITEM
   add constraint AK_AK_ORDER_LINE_ITEM_ORDER_LI unique (ORDER_GUID, SERVICE_CDE, SEQ_NUM)
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_LINE_ITEM to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_LINE_ITEM to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_NOTIFICATION                                    */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_NOTIFICATION (
...
comment on table TS_ORDER_MGMT.ORDER_NOTIFICATION is
...
comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION.APPLICABLE_RESOURCE_ROLE_CDE is
'The role this Task or Alert should be assigned to.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.ORDER_NOTIFICATION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_NOTIFICATION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_NOTIFICATION_EVENT                              */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT (
   ORDER_NOTIFICATION_EVENT_IID NUMBER                not null
      generated by default as identity ( start with 1),
   ORDER_GUID           RAW(16)              default SYS_GUID()  not null,
   ORDER_NOTIFICATION_IID NUMBER                not null,
...
comment on table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT is
...
comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.ORDER_GUID is
'Customer Order Global ID. Customer Order that is created on behalf of the recipient who receives infusion of the stem cell product.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.ORDER_NOTIFICATION_IID is
'Link to the Task/Alert and applicable role to assign to.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.CASE_RESOURCE_IID is
'Contains the login ID of the person completing the task/alert.  This login ID is captured and cached at login time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.TRANSPORTATION_REQUEST_IID is
'Optional link to the Transportation Request, used only for transportation-related tasks/alerts.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.ORDER_NOTIFICATION_STATUS_IID is
'Link to the current status of this task/alert.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT.ORDER_NOTIFICATION_DUE_DTE is
'Date the task/alert should be completed by.'
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT
...
grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_NOTIFICATION_STATUS                             */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS (
   ORDER_NOTIFICATION_STATUS_IID NUMBER                not null
...
comment on table TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS is
'Tasks Status Values:
...
comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.ORDER_NOTIFICATION_STATUS_CDE is
...
comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.ORDER_NOTIFICATION_TYPE_CDE is
'Known Values are "Phase", "Milestone" and "Task"'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.ORDER_NOTIFICATION_STATUS_NME is
...
comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS
   add constraint AK_ORDER_NOTIFICATION_STATUS unique (ORDER_NOTIFICATION_STATUS_CDE, ORDER_NOTIFICATION_TYPE_CDE)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_NOTIFICATION_TYPE                               */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE (
   ORDER_NOTIFICATION_TYPE_CDE VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE is
'Values are: TASK or ALERT
Tasks need to be acted upon.  Alerts are informational only.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.ORDER_NOTIFICATION_TYPE_CDE is
'Known Values are "Phase", "Milestone" and "Task"'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.ORDER_NOTIFICATION_TYPE_NME is
'Description used to distinguish one phase from another'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_OPTION                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_OPTION (
   ORDER_OPTION_IID     NUMBER(9)             not null
      generated by default as identity ( start with 1),
   OPTION_VALUE_IID     NUMBER(9)             not null,
...
comment on table TS_ORDER_MGMT.ORDER_OPTION is
'Options specified as part of the request (CUSTOMER ORDER). For example, a PBSC as a product for WU service.'
/

comment on column TS_ORDER_MGMT.ORDER_OPTION.ORDER_LINE_ITEM_IID is
'PK'
/

comment on column TS_ORDER_MGMT.ORDER_OPTION.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_OPTION.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_OPTION.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_OPTION.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_OPTION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_OPTION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_RELEASE_REASON                                  */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_RELEASE_REASON (
...
comment on table TS_ORDER_MGMT.ORDER_RELEASE_REASON is
'PPR	Payment Received
HUM	Humanitarian'
/

comment on column TS_ORDER_MGMT.ORDER_RELEASE_REASON.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_RELEASE_REASON.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_RELEASE_REASON.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_RELEASE_REASON.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_RELEASE_REASON to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_RELEASE_REASON to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_STATUS                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_STATUS (
...
comment on table TS_ORDER_MGMT.ORDER_STATUS is
'Values:
OPEN	                Open Request
...
comment on column TS_ORDER_MGMT.ORDER_STATUS.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_STATUS.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_STATUS.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_STATUS.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_STATUS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_STATUS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_SUBJECT_FACTOR                                  */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR (
...
comment on table TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR is
...
comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_SUBJECT_FACTOR_VALUE                            */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE (
...
comment on table TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE is
...
comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_TRACKING                                        */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_TRACKING (
   ORDER_TRACKING_IID   NUMBER(9)             not null
      generated by default as identity ( start with 1),
...
comment on table TS_ORDER_MGMT.ORDER_TRACKING is
...
comment on column TS_ORDER_MGMT.ORDER_TRACKING.ORDER_TRACKING_IID is
'PK'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.ORDER_LINE_ITEM_IID is
'FK back to the ORDER_LINE_ITEM table; identifies which order the Tracking is for.'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.TRACKING_SEQ_NUM is
...
comment on column TS_ORDER_MGMT.ORDER_TRACKING.TRACKING_VALUE_DTE is
'A date value for the tracking code if the tracking code is DATE (APPTDATE, SHIPDATE, RESULTSDATE, etc.)'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.TRACKING_VALUE_NUM is
'A numeric value for the tracking code if the tracking code is NUMBER. '
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.TRACKING_VALUE_TXT is
...
comment on column TS_ORDER_MGMT.ORDER_TRACKING.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_TRACKING.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

alter table TS_ORDER_MGMT.ORDER_TRACKING
   add constraint AK_ORDER_TRACKING unique (ORDER_LINE_ITEM_IID, TRACKING_CDE, TRACKING_SEQ_NUM)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_TRACKING to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_TRACKING to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: ORDER_TYPE                                            */
/*==============================================================*/
create table TS_ORDER_MGMT.ORDER_TYPE (
   ORDER_TYPE_CDE       VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.ORDER_TYPE is
'Values:
CUSTOMER	CUSTOMER
FULFILL	FULFILL'
/

comment on column TS_ORDER_MGMT.ORDER_TYPE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_TYPE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.ORDER_TYPE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.ORDER_TYPE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.ORDER_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.ORDER_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: PROJECT                                               */
/*==============================================================*/
create table TS_ORDER_MGMT.PROJECT (
...
comment on table TS_ORDER_MGMT.PROJECT is
'BIOPRJ	BioTherapies
TCPROJ	None
...
comment on column TS_ORDER_MGMT.PROJECT.PROJECT_CDE is
'Project code for the order. '
/

comment on column TS_ORDER_MGMT.PROJECT.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.PROJECT.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.PROJECT.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.PROJECT.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.PROJECT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.PROJECT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: PROPOSED_ORDER_TRACKING                               */
/*==============================================================*/
create table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING (
   ORDER_LINE_ITEM_IID  NUMBER(9)             not null,
...
comment on table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING.ORDER_LINE_ITEM_IID is
'Order Line which contains the tracking field which needs to go through an approval or other type of workflow.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING.TRACKING_CDE is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING.TRACKING_CURRENT_VALUE_TXT is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: PROPOSED_ORDER_TRACKING_STATE                         */
/*==============================================================*/
create table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE (
   PROPOSED_ORDER_TRACK_STATE_IID NUMBER                not null
      generated by default as identity ( start with 1),
   ORDER_LINE_ITEM_IID  NUMBER(9),
   TRACKING_CDE         VARCHAR2(20 CHAR),
...
comment on table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.ORDER_LINE_ITEM_IID is
'Order Line which contains the ''tracking'' field which needs to go through an approval or other type of workflow.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.BP_GUID is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.TRACKING_REQUEST_TS is
'The date the Resource (usually Case Manager) sent the request to the Business Party(ies).'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.PROPOSED_TRACKING_STATUS_CDE is
'The status codes reflect the various states the Tracking field may pass through before reaching a final state.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.CASE_RESOURCE_IID is
'The NMDP IID assigned to each resource capable of performing a trackable task.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.PROPOSED_TRACKING_VALUE_TXT is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.TRACKING_VALUE_FINAL_STATE_TS is
'A timestamp upon which a Tracking field received a response from the Business Party.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE.TRACKING_VALUE_COMMENTS_TXT is
'A field to pass anything of value to the Business Party regarding this Tracking field request.'
/

alter table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE
...
grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: PROPOSED_ORDER_TRACKING_STATUS                        */
/*==============================================================*/
create table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS (
   PROPOSED_TRACKING_STATUS_CDE VARCHAR2(20 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS is
...
comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS.PROPOSED_TRACKING_STATUS_CDE is
'Short version of all Proposed Order Tracking statuses.
Values: Pending, Approved, Rejected, Informational.'
/

comment on column TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS.PROPOSED_TRACKING_STATUS_NME is
'More descriptive text of all Proposed Order Tracking statuses.'
/

grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SALABLE_SERVICE                                       */
/*==============================================================*/
create table TS_ORDER_MGMT.SALABLE_SERVICE (
   SERVICE_CDE          VARCHAR2(50 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SALABLE_SERVICE is
...
comment on column TS_ORDER_MGMT.SALABLE_SERVICE.SERVICE_CDE is
'The code of the salable service'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.STEM_CELL_SUPPLIER_BP_GUID is
...
comment on column TS_ORDER_MGMT.SALABLE_SERVICE.SOURCE_TYPE_CDE is
'A type of the Stem-Cell Source - Donor or CBU'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.EFFECTIVE_DTE is
'The date a service is salable.'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.DISCONTINUED_DTE is
'The date a serive is no longer salable (disountinued)'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.SALABLE_IND is
'Indicated whether a service can be offered for sale.'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.CUSTOMER_BLOCK_IND is
...
comment on column TS_ORDER_MGMT.SALABLE_SERVICE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SALABLE_SERVICE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SALABLE_SERVICE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SALABLE_SERVICE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE                                               */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE (
   SERVICE_CDE          VARCHAR2(50 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SERVICE is
...
comment on column TS_ORDER_MGMT.SERVICE.SERVICE_CDE is
'A code indicating the Service.'
/

comment on column TS_ORDER_MGMT.SERVICE.SERVICE_DESC is
'A description of the Service'
/

comment on column TS_ORDER_MGMT.SERVICE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_ITEMIZATION                                   */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_ITEMIZATION (
   SERVICE_ITEMIZATION_IID NUMBER(9)             not null
...
comment on table TS_ORDER_MGMT.SERVICE_ITEMIZATION is
...
comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.BP_GUID is
'Global Identifier of the Business party. '
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.SERVICE_CDE is
'A code indicating the Service.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.DETAIL_SERVICE_CDE is
'A code indicating the Service.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.SERVICE_ITEMIZATION_TYPE_CDE is
...
comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.SOURCE_TYPE_CDE is
'A code indicating whether it''s a Donor or a Cord.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.DEFAULT_IND is
...
comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_ITEMIZATION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_ITEMIZATION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_ITEMIZATION_TYPE                              */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE (
   SERVICE_ITEMIZATION_TYPE_CDE VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE is
...
comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.SERVICE_ITEMIZATION_TYPE_CDE is
'A type code associated with the specific itemization.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.SERVICE_ITEMIZATION_DESC is
'A business description of the code above.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_OPTION                                        */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_OPTION (
   OPTION_CDE           VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SERVICE_OPTION is
...
comment on column TS_ORDER_MGMT.SERVICE_OPTION.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_OPTION to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_OPTION to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_OPTION_VALUE                                  */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_OPTION_VALUE (
   SERVICE_OPTION_VALUE_IID NUMBER(9)             not null
...
comment on table TS_ORDER_MGMT.SERVICE_OPTION_VALUE is
...
comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.BP_GUID is
'Global Identifier of the Business party. '
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.SOURCE_TYPE_CDE is
'A code indicating whether it''s a Donor or a Cord.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_OPTION_VALUE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_OPTION_VALUE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_OPTION_VALUE to TS_ORDER_MGMT_RO_USER
/

grant INDEX on TS_ORDER_MGMT.SERVICE_OPTION_VALUE to TS_SUBJECT_MGMT_APP_USER
/

/*==============================================================*/
/* Table: SERVICE_PROVIDER                                      */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_PROVIDER (
   SERVICE_PROVIDER_IID NUMBER                not null
      generated by default as identity ( start with 1),
   ORDER_LINE_ITEM_IID  NUMBER(9)             not null,
   BP_GUID              RAW(16)              default SYS_GUID(),
...
comment on table TS_ORDER_MGMT.SERVICE_PROVIDER is
...
comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.SERVICE_PROVIDER_IID is
...
comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.ORDER_LINE_ITEM_IID is
'FK to the ORDER_LINE_ITEM table.  Represents a specific line (service) on a Fulfillment Order.'
/

comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.BP_GUID is
...
comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.ORDER_BP_START_TS is
...
comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.ORDER_BP_TYPE_CDE is
...
comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_PROVIDER.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

alter table TS_ORDER_MGMT.SERVICE_PROVIDER
   add constraint AK_SERVICE_PROVIDER unique (ORDER_LINE_ITEM_IID, BP_GUID, ORDER_BP_TYPE_CDE, ORDER_BP_START_TS)
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_PROVIDER to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_PROVIDER to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_TRACKING                                      */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_TRACKING (
   TRACKING_CDE         VARCHAR2(20 CHAR)     not null,
   SERVICE_CDE          VARCHAR2(50 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SERVICE_TRACKING is
...
comment on column TS_ORDER_MGMT.SERVICE_TRACKING.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_TRACKING.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_TRACKING.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_TRACKING.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_TRACKING to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_TRACKING to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SERVICE_TYPE                                          */
/*==============================================================*/
create table TS_ORDER_MGMT.SERVICE_TYPE (
   SERVICE_TYPE_CDE     VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SERVICE_TYPE is
'TYP	Typing
...
comment on column TS_ORDER_MGMT.SERVICE_TYPE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_TYPE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SERVICE_TYPE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SERVICE_TYPE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SERVICE_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SERVICE_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: SOURCE_TYPE                                           */
/*==============================================================*/
create table TS_ORDER_MGMT.SOURCE_TYPE (
   SOURCE_TYPE_CDE      VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.SOURCE_TYPE is
'List of source types. Currently Donor and Cord.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.SOURCE_TYPE_CDE is
'A code indicating whether it''s a Donor or a Cord.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.SOURCE_TYPE_DESC is
'A description associated with the code.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.SOURCE_TYPE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.SOURCE_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.SOURCE_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRACKING                                              */
/*==============================================================*/
create table TS_ORDER_MGMT.TRACKING (
   TRACKING_CDE         VARCHAR2(20 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.TRACKING is
...
comment on column TS_ORDER_MGMT.TRACKING.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.TRACKING.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.TRACKING.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.TRACKING.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.TRACKING to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRACKING to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRACKING_VALUE                                        */
/*==============================================================*/
create table TS_ORDER_MGMT.TRACKING_VALUE (
   TRACKING_CDE         VARCHAR2(20 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.TRACKING_VALUE is
...
comment on column TS_ORDER_MGMT.TRACKING_VALUE.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.TRACKING_VALUE.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.TRACKING_VALUE.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.TRACKING_VALUE.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,SELECT,UPDATE,INSERT on TS_ORDER_MGMT.TRACKING_VALUE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRACKING_VALUE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORTATION_REQUEST                                */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORTATION_REQUEST (
   TRANSPORTATION_REQUEST_IID NUMBER                not null
      generated by default as identity ( start with 1),
   ORDER_LINE_ITEM_IID  NUMBER(9)             not null,
...
comment on table TS_ORDER_MGMT.TRANSPORTATION_REQUEST is
'Each row in the Transportation Request table represents a single shipment for a single order line.'
/

comment on column TS_ORDER_MGMT.TRANSPORTATION_REQUEST.ORDER_LINE_ITEM_IID is
'PK'
/

comment on column TS_ORDER_MGMT.TRANSPORTATION_REQUEST.ORDER_LINE_ITEM_TRANSPORT_NUM is
...
comment on column TS_ORDER_MGMT.TRANSPORTATION_REQUEST.LOGISTICS_COORDINATOR_IID is
'The NMDP IID assigned to each resource capable of performing a trackable task.'
/

comment on column TS_ORDER_MGMT.TRANSPORTATION_REQUEST.PICK_UP_PREFERENCES_TXT is
...
comment on column TS_ORDER_MGMT.TRANSPORTATION_REQUEST.DELIVERY_PREFERENCES_TXT is
'Open text field for the Manufacturer to specify a new date/time.'
/

alter table TS_ORDER_MGMT.TRANSPORTATION_REQUEST
   add constraint AK_TRANSPORTATION_REQUEST unique (ORDER_LINE_ITEM_IID, ORDER_LINE_ITEM_TRANSPORT_NUM)
      using index tablespace TS_ORDER_MGMT_IDX
/

grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.TRANSPORTATION_REQUEST to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORTATION_REQUEST to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_ADDRESS                                     */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_ADDRESS (
   TRANSPORT_ADDRESS_IID NUMBER                not null
      generated by default as identity ( start with 1),
   TRANSPORT_ADDRESS_TYPE_CDE VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.TRANSPORT_ADDRESS is
...
comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.TRANSPORT_ADDRESS_IID is
'PK'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.TRANSPORT_ADDRESS_TYPE_CDE is
'A type of the address. For example, Customer or Freight Forwarder.'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.ADDRESS_1_TXT is
'A first line of a mailing address.'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.ADDRESS_2_TXT is
'A second line of a mailing address (if needed).'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.CITY_NME is
'A city of the business party address. '
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.STATE_CDE is
'State is the code abbreviation for the state from an address. Can be more than 2 characters. '
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.ZIP_POSTAL_CDE is
'A zip code of the business party address. '
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.COUNTRY_CDE is
'A country code of the business party address. '
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.UPDATE_TS is
'The date the record was updated in the database table. This value can change over time.'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.UPDATE_BY_ID is
'Indicates the user/system which imparted the update to the record. This value will change over time.'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.CREATE_TS is
'The date the record was inserted into the database table. This value will never change.'
/

comment on column TS_ORDER_MGMT.TRANSPORT_ADDRESS.CREATE_BY_ID is
'Indicates the user/system which imparted the creation of the record. This value will never change.'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.TRANSPORT_ADDRESS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_ADDRESS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_ADDRESS_TYPE                                */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_ADDRESS_TYPE (
   TRANSPORT_ADDRESS_TYPE_CDE VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.TRANSPORT_ADDRESS_TYPE is
'
...
grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.TRANSPORT_ADDRESS_TYPE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_ADDRESS_TYPE to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_CONTACT                                     */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_CONTACT (
   TRANSPORT_CONTACT_IID NUMBER                not null
      generated by default as identity ( start with 1),
...
comment on table TS_ORDER_MGMT.TRANSPORT_CONTACT is
...
comment on column TS_ORDER_MGMT.TRANSPORT_CONTACT.CONTACT_NME is
...
comment on column TS_ORDER_MGMT.TRANSPORT_CONTACT.CONTACT_PHONE_NUM_TXT is
...
comment on column TS_ORDER_MGMT.TRANSPORT_CONTACT.BP_GUID is
...
alter table TS_ORDER_MGMT.TRANSPORT_CONTACT
   add constraint AK_TRANSPORT_CONTACT unique (CONTACT_NME, CONTACT_PHONE_NUM_TXT)
/

grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.TRANSPORT_CONTACT to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_CONTACT to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_DETAIL_METHOD                               */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_DETAIL_METHOD (
...
comment on table TS_ORDER_MGMT.TRANSPORT_DETAIL_METHOD is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.TRANSPORT_DETAIL_METHOD to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_DETAIL_METHOD to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_DETAIL_RULES                                */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES (
   TRANSPORT_DETAIL_METHOD_CDE VARCHAR2(10 CHAR)     not null,
   OPTION_VALUE_IID     NUMBER(9)             not null,
...
comment on table TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES is
...
comment on column TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES.TRANSPORT_DETAIL_DISPLAY_NME is
...
grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_PARTNER                                     */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_PARTNER (
   TRANSPORT_PARTNER_IID NUMBER                not null
      generated by default as identity ( start with 1),
...
comment on table TS_ORDER_MGMT.TRANSPORT_PARTNER is
...
grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.TRANSPORT_PARTNER to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_PARTNER to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_REQUEST_STATUS                              */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_REQUEST_STATUS (
   TRANSPORT_REQUEST_STATUS_CDE VARCHAR2(10 CHAR)     not null,
...
comment on table TS_ORDER_MGMT.TRANSPORT_REQUEST_STATUS is
'* Request not started
Review Request
Place Order
Review Itinerary 
...
grant DELETE,INSERT,UPDATE,SELECT on TS_ORDER_MGMT.TRANSPORT_REQUEST_STATUS to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_REQUEST_STATUS to TS_ORDER_MGMT_RO_USER
/

/*==============================================================*/
/* Table: TRANSPORT_TEMPERATURE                                 */
/*==============================================================*/
create table TS_ORDER_MGMT.TRANSPORT_TEMPERATURE (
...
comment on table TS_ORDER_MGMT.TRANSPORT_TEMPERATURE is
'* Room Temperature
* Cooled
* Cryopreserved'
/

grant DELETE,INSERT,SELECT,UPDATE on TS_ORDER_MGMT.TRANSPORT_TEMPERATURE to TS_ORDER_MGMT_APP_USER
/

grant SELECT on TS_ORDER_MGMT.TRANSPORT_TEMPERATURE to TS_ORDER_MGMT_RO_USER
/

alter table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT
   add constraint FK_CUSTOMER_ORDER_SUBJECT_03 foreign key (ORDER_GUID)
      references TS_ORDER_MGMT.ORDER_HEADER (ORDER_GUID)
      not deferrable
/

alter table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT
   add constraint FK_CUSTOMER_ORDER_SUBJECT_04 foreign key (PROJECT_CDE)
      references TS_ORDER_MGMT.PROJECT (PROJECT_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.CUSTOMER_ORDER_SUBJECT
   add constraint FK_CUSTOMER_ORDER_SUBJECT_06 foreign key (RELEASE_REASON_CDE)
      references TS_ORDER_MGMT.ORDER_RELEASE_REASON (RELEASE_REASON_CDE)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM
   add constraint FK_DYNAMIC_FORM_01 foreign key (DYNAMIC_FORM_TYPE_CDE)
      references TS_ORDER_MGMT.DYNAMIC_FORM_TYPE (DYNAMIC_FORM_TYPE_CDE)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT
   add constraint FK_DYNAMIC_FORM_COMPONENT_01 foreign key (FORM_SECTION_IID)
      references TS_ORDER_MGMT.DYNAMIC_FORM_SECTION (FORM_SECTION_IID)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD
   add constraint FK_DYNAMIC_FORM_FIELD_01 foreign key (FORM_COMPONENT_IID)
      references TS_ORDER_MGMT.DYNAMIC_FORM_COMPONENT (FORM_COMPONENT_IID)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD
   add constraint FK_DYNAMIC_FORM_FIELD_02 foreign key (FORM_FIELD_TYPE_CDE)
      references TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_TYPE (FORM_FIELD_TYPE_CDE)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_OPTION
   add constraint FK_DYNAMIC_FORMFIELD_OPTION_01 foreign key (FORM_FIELD_IID)
      references TS_ORDER_MGMT.DYNAMIC_FORM_FIELD (FORM_FIELD_IID)
/

alter table TS_ORDER_MGMT.DYNAMIC_FORM_FIELD_VALUE
   add constraint FK_DYNAMIC_FORM_FIELD_VALUE_01 foreign key (DYNAMIC_FORM_IID)
      references TS_ORDER_MGMT.DYNAMIC_FORM (DYNAMIC_FORM_IID)
/
...
alter table TS_ORDER_MGMT.DYNAMIC_FORM_SECTION
   add constraint FK_DYNAMIC_FORM_SECTION_01 foreign key (DYNAMIC_FORM_IID)
      references TS_ORDER_MGMT.DYNAMIC_FORM (DYNAMIC_FORM_IID)
/

alter table TS_ORDER_MGMT.FORM_RESOURCE_ROLE
   add constraint FK_FORM_RESOURCE_ROLE_01 foreign key (RESOURCE_ROLE_CDE)
      references TS_SUBJECT_MGMT.RESOURCE_ROLE (RESOURCE_ROLE_CDE)
/

alter table TS_ORDER_MGMT.FORM_RESOURCE_ROLE
   add constraint FK_FORM_RESOURCE_ROLE_02 foreign key (FORM_IID)
      references TS_ORDER_MGMT.FORM_MASTER_LIST (FORM_IID)
/

alter table TS_ORDER_MGMT.OPTION_VALUE
   add constraint FK_OPTION_VALUE_01 foreign key (OPTION_CDE)
      references TS_ORDER_MGMT.SERVICE_OPTION (OPTION_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_HEADER
   add constraint FK_ORDER_HEADER_02 foreign key (ORDER_TYPE_CDE)
      references TS_ORDER_MGMT.ORDER_TYPE (ORDER_TYPE_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_HEADER
   add constraint FK_ORDER_HEADER_03 foreign key (ORDER_STATUS_CDE)
      references TS_ORDER_MGMT.ORDER_STATUS (ORDER_STATUS_CDE)
      not deferrable
/
...
alter table TS_ORDER_MGMT.ORDER_HEADER
   add constraint FK_ORDER_HEADER_07 foreign key (CLOSE_REASON_CDE)
      references TS_ORDER_MGMT.CLOSE_REASON (CLOSE_REASON_CDE)
      not deferrable
/
...
alter table TS_ORDER_MGMT.ORDER_LINE_ITEM
   add constraint FK_ORDER_LINE_ITEM_02 foreign key (LINKED_ORDER_LINE_ITEM_IID)
      references TS_ORDER_MGMT.ORDER_LINE_ITEM (ORDER_LINE_ITEM_IID)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_LINE_ITEM
   add constraint FK_ORDER_LINE_ITEM_03 foreign key (SERVICE_CDE)
      references TS_ORDER_MGMT.SERVICE (SERVICE_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_LINE_ITEM
   add constraint FK_ORDER_LINE_ITEM_04 foreign key (CANCEL_REASON_CDE)
      references TS_ORDER_MGMT.CANCEL_REASON (CANCEL_REASON_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION
   add constraint FK_ORDER_NOTIFICATION_02 foreign key (ORDER_NOTIFICATION_TYPE_CDE)
      references TS_ORDER_MGMT.ORDER_NOTIFICATION_TYPE (ORDER_NOTIFICATION_TYPE_CDE)
/
...
alter table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT
   add constraint FK_ORDER_NOTIFICATION_EVENT_03 foreign key (ORDER_NOTIFICATION_STATUS_IID)
      references TS_ORDER_MGMT.ORDER_NOTIFICATION_STATUS (ORDER_NOTIFICATION_STATUS_IID)
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT
   add constraint FK_ORDER_NOTIFICATION_EVENT_04 foreign key (ORDER_NOTIFICATION_IID)
      references TS_ORDER_MGMT.ORDER_NOTIFICATION (ORDER_NOTIFICATION_IID)
/

alter table TS_ORDER_MGMT.ORDER_NOTIFICATION_EVENT
   add constraint FK_ORDER_NOTIFICATION_EVENT_05 foreign key (TRANSPORTATION_REQUEST_IID)
      references TS_ORDER_MGMT.TRANSPORTATION_REQUEST (TRANSPORTATION_REQUEST_IID)
/
...
alter table TS_ORDER_MGMT.ORDER_OPTION
...
alter table TS_ORDER_MGMT.ORDER_OPTION
   add constraint FK_ORDER_OPTION_02 foreign key (OPTION_VALUE_IID)
      references TS_ORDER_MGMT.OPTION_VALUE (OPTION_VALUE_IID)
      not deferrable
/

alter table TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE
   add constraint FK_ORDER_SUBJECT_FACTOR_VAL_01 foreign key (ORDER_SUBJECT_FACTOR_CDE)
      references TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR (ORDER_SUBJECT_FACTOR_CDE)
      not deferrable
/
...
alter table TS_ORDER_MGMT.ORDER_TRACKING
   add constraint FK_ORDER_TRACKING_02 foreign key (TRACKING_CDE)
      references TS_ORDER_MGMT.TRACKING (TRACKING_CDE)
      not deferrable
/

alter table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING
...
alter table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE
   add constraint FK_PROPOSED_ORD_TRACK_STATE_01 foreign key (PROPOSED_TRACKING_STATUS_CDE)
      references TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATUS (PROPOSED_TRACKING_STATUS_CDE)
/

alter table TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING_STATE
   add constraint FK_PROPOSED_ORD_TRACK_STATE_02 foreign key (ORDER_LINE_ITEM_IID, TRACKING_CDE)
      references TS_ORDER_MGMT.PROPOSED_ORDER_TRACKING (ORDER_LINE_ITEM_IID, TRACKING_CDE)
/

alter table TS_ORDER_MGMT.SALABLE_SERVICE
...
alter table TS_ORDER_MGMT.SALABLE_SERVICE
   add constraint FK_SALABLE_SERVICE_02 foreign key (SOURCE_TYPE_CDE)
      references TS_ORDER_MGMT.SOURCE_TYPE (SOURCE_TYPE_CDE)
/

alter table TS_ORDER_MGMT.SALABLE_SERVICE
   add constraint FK_SALABLE_SERVICE_03 foreign key (ORDER_SUBJECT_FACTOR_VALUE_IID)
      references TS_ORDER_MGMT.ORDER_SUBJECT_FACTOR_VALUE (ORDER_SUBJECT_FACTOR_VALUE_IID)
/

alter table TS_ORDER_MGMT.SERVICE
   add constraint FK_SERVICE_01 foreign key (SERVICE_TYPE_CDE)
      references TS_ORDER_MGMT.SERVICE_TYPE (SERVICE_TYPE_CDE)
/

alter table TS_ORDER_MGMT.SERVICE_ITEMIZATION
...
alter table TS_ORDER_MGMT.SERVICE_ITEMIZATION
   add constraint FK_SERVICE_ITEMIZATION_03 foreign key (SERVICE_ITEMIZATION_TYPE_CDE)
      references TS_ORDER_MGMT.SERVICE_ITEMIZATION_TYPE (SERVICE_ITEMIZATION_TYPE_CDE)
      not deferrable
/
...
alter table TS_ORDER_MGMT.SERVICE_OPTION_VALUE
...
alter table TS_ORDER_MGMT.SERVICE_TRACKING
...
alter table TS_ORDER_MGMT.TRACKING_VALUE
...
alter table TS_ORDER_MGMT.TRANSPORTATION_REQUEST
   add constraint FK_TRANSPORTATION_REQUEST_02 foreign key (TRANSPORT_PARTNER_IID)
      references TS_ORDER_MGMT.TRANSPORT_PARTNER (TRANSPORT_PARTNER_IID)
/

alter table TS_ORDER_MGMT.TRANSPORTATION_REQUEST
   add constraint FK_TRANSPORTATION_REQUEST_03 foreign key (TRANSPORT_REQUEST_STATUS_CDE)
      references TS_ORDER_MGMT.TRANSPORT_REQUEST_STATUS (TRANSPORT_REQUEST_STATUS_CDE)
/

alter table TS_ORDER_MGMT.TRANSPORTATION_REQUEST
   add constraint FK_TRANSPORTATION_REQUEST_04 foreign key (TRANSPORT_TEMPERATURE_CDE)
      references TS_ORDER_MGMT.TRANSPORT_TEMPERATURE (TRANSPORT_TEMPERATURE_CDE)
/
...
alter table TS_ORDER_MGMT.TRANSPORTATION_REQUEST
   add constraint FK_TRANSPORTATION_REQUEST_07 foreign key (PICK_UP_FROM_ADDRESS_IID)
      references TS_ORDER_MGMT.TRANSPORT_ADDRESS (TRANSPORT_ADDRESS_IID)
/
...
alter table TS_ORDER_MGMT.TRANSPORT_ADDRESS
   add constraint FK_TRANSPORT_ADDRESS_01 foreign key (TRANSPORT_ADDRESS_TYPE_CDE)
      references TS_ORDER_MGMT.TRANSPORT_ADDRESS_TYPE (TRANSPORT_ADDRESS_TYPE_CDE)
/

alter table TS_ORDER_MGMT.TRANSPORT_ADDRESS
   add constraint FK_TRANSPORT_ADDRESS_02 foreign key (TRANSPORT_CONTACT_IID)
      references TS_ORDER_MGMT.TRANSPORT_CONTACT (TRANSPORT_CONTACT_IID)
/

alter table TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES
...
alter table TS_ORDER_MGMT.TRANSPORT_DETAIL_RULES
   add constraint FK_TRANSPORT_DETAIL_RULES_02 foreign key (TRANSPORT_DETAIL_METHOD_CDE)
      references TS_ORDER_MGMT.TRANSPORT_DETAIL_METHOD (TRANSPORT_DETAIL_METHOD_CDE)
/
